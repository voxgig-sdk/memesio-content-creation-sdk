...
from memesiocontentcreation_sdk.utility import register

# Load features
from memesiocontentcreation_sdk.feature.base_feature import MemesioContentCreationBaseFeature
from memesiocontentcreation_sdk.features import _has_feature, _make_feature
...
class MemesioContentCreationSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MemesioContentCreationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Agent(self, data=None) -> "AgentEntity":
        ...
        from memesiocontentcreation_sdk.entity.agent_entity import AgentEntity
    ...
    def AgentInfra(self, data=None) -> "AgentInfraEntity":
        ...
        from memesiocontentcreation_sdk.entity.agent_infra_entity import AgentInfraEntity
    ...
    def AiCaption(self, data=None) -> "AiCaptionEntity":
        ...
        from memesiocontentcreation_sdk.entity.ai_caption_entity import AiCaptionEntity
    ...
    def AiJob(self, data=None) -> "AiJobEntity":
        ...
        from memesiocontentcreation_sdk.entity.ai_job_entity import AiJobEntity
    ...
    def AiMemeGenerationSucceeded(self, data=None) -> "AiMemeGenerationSucceededEntity":
        ...
        from memesiocontentcreation_sdk.entity.ai_meme_generation_succeeded_entity import AiMemeGenerationSucceededEntity
    ...
    def AiProvider(self, data=None) -> "AiProviderEntity":
        ...
        from memesiocontentcreation_sdk.entity.ai_provider_entity import AiProviderEntity
    ...
    def Analytics(self, data=None) -> "AnalyticsEntity":
        ...
        from memesiocontentcreation_sdk.entity.analytics_entity import AnalyticsEntity
        return AnalyticsEntity(self, data)


    def Auth(self, data=None) -> "AuthEntity":
        """Entity factory: client.Auth().list() / client.Auth().load({"id": ...})."""
        from memesiocontentcreation_sdk.entity.auth_entity import AuthEntity
    ...
    def Billing(self, data=None) -> "BillingEntity":
        ...
        from memesiocontentcreation_sdk.entity.billing_entity import BillingEntity
    ...
    def Collaboration(self, data=None) -> "CollaborationEntity":
        ...
        from memesiocontentcreation_sdk.entity.collaboration_entity import CollaborationEntity
    ...
    def Compliance(self, data=None) -> "ComplianceEntity":
        ...
        from memesiocontentcreation_sdk.entity.compliance_entity import ComplianceEntity
    ...
    def CreateMeme(self, data=None) -> "CreateMemeEntity":
        ...
        from memesiocontentcreation_sdk.entity.create_meme_entity import CreateMemeEntity
    ...
    def DeveloperApi(self, data=None) -> "DeveloperApiEntity":
        ...
        from memesiocontentcreation_sdk.entity.developer_api_entity import DeveloperApiEntity
