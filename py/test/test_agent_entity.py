    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set MEMESIOCONTENTCREATION_TEST_AGENT_ENTID JSON to run live")
        client = setup["client"]
        ...
        agent_ref01_data = helpers.to_map(agent_ref01_ent.create(agent_ref01_data, None))
        ...
        agent_ref01_resdata_up0 = helpers.to_map(agent_ref01_ent.update(agent_ref01_data_up0_up, None))
...
def _agent_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("MEMESIOCONTENTCREATION_TEST_AGENT_ENTID"))
