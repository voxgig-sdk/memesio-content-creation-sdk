    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set MEMESIO_CONTENT_CREATION_TEST_TREND_ALERT_ENTID JSON to run live")
        client = setup["client"]
        ...
        trend_alert_ref01_data = helpers.to_map(runner.entity_data(trend_alert_ref01_ent.create(trend_alert_ref01_data, None)))
...
def _trend_alert_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("MEMESIO_CONTENT_CREATION_TEST_TREND_ALERT_ENTID"))
