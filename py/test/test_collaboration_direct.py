...
class TestCollaborationDirect:
    ...
    def test_should_direct_load_collaboration(self):
        setup = _collaboration_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-collaboration", "live" if setup["live"] else "unit")
        if _skip:
