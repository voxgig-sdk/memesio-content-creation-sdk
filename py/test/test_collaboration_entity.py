    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set MEMESIO_CONTENT_CREATION_TEST_COLLABORATION_ENTID JSON to run live")
        client = setup["client"]
        ...
        collaboration_ref01_data = helpers.to_map(runner.entity_data(collaboration_ref01_ent.create(collaboration_ref01_data, None)))
...
def _collaboration_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "MEMESIO_CONTENT_CREATION_TEST_COLLABORATION_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("MEMESIO_CONTENT_CREATION_TEST_COLLABORATION_ENTID"))
