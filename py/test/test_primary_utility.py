...
from memesiocontentcreation_sdk.core.response import MemesioContentCreationResponse
from memesiocontentcreation_sdk.core.operation import MemesioContentCreationOperation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return MemesioContentCreationError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = MemesioContentCreationSDK.test(None, None)
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except MemesioContentCreationError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = MemesioContentCreationResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = MemesioContentCreationSDK.test(None, None)
        ...
        class TestInitFeature(MemesioContentCreationBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MemesioContentCreationBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = MemesioContentCreationSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = MemesioContentCreationSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MemesioContentCreationSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MemesioContentCreationSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = MemesioContentCreationOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MemesioContentCreationSDK.test(None, setup_opts)
