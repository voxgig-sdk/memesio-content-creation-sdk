    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set MEMESIOCONTENTCREATION_TEST_DEVELOPER_API_ENTID JSON to run live")
        client = setup["client"]
        ...
        developer_api_ref01_data = helpers.to_map(developer_api_ref01_ent.create(developer_api_ref01_data, None))
...
def _developer_api_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("MEMESIOCONTENTCREATION_TEST_DEVELOPER_API_ENTID"))
