# MemesioContentCreation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MemesioContentCreationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MemesioContentCreationSDK(...) and MemesioContentCreationSDK.test(...) become
#      MemesioContentCreationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "memesiocontentcreation_sdk"
_SDK_CLASS = "MemesioContentCreationSDK"
...
_ENTITIES = {
    "Agent": "agent",
    "AgentInfra": "agent_infra",
    "AiCaption": "ai_caption",
    "AiJob": "ai_job",
    "AiMemeGenerationSucceeded": "ai_meme_generation_succeeded",
    ...
    "CreateMeme": "create_meme",
    "DeveloperApi": "developer_api",
    "FreeCaptionMemeSuccess": "free_caption_meme_success",
    "FreeTemplateSearch": "free_template_search",
    "Generate": "generate",
    "Growth": "growth",
    "ListMeme": "list_meme",
    "Media": "media",
    "Meme": "meme",
    "PublicTemplateMediaItem": "public_template_media_item",
    "StandaloneAgentBootstrap": "standalone_agent_bootstrap",
    "Template": "template",
    "TemplateSearch": "template_search",
    "TrendAlert": "trend_alert",
    "UploadCaptionMemeSuccess": "upload_caption_meme_success",
    "Video": "video",
}
