    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set MEMESIOCONTENTCREATION_TEST_AI_CAPTION_ENTID JSON to run live")
        client = setup["client"]
        ...
        ai_caption_ref01_data = helpers.to_map(ai_caption_ref01_ent.create(ai_caption_ref01_data, None))
...
def _ai_caption_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("MEMESIOCONTENTCREATION_TEST_AI_CAPTION_ENTID"))
