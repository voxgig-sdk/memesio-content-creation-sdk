    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set MEMESIO_CONTENT_CREATION_TEST_CREATE_MEME_ENTID JSON to run live")
        client = setup["client"]
        ...
        create_meme_ref01_data = helpers.to_map(runner.entity_data(create_meme_ref01_ent.create(create_meme_ref01_data, None)))
...
def _create_meme_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "MEMESIO_CONTENT_CREATION_TEST_CREATE_MEME_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("MEMESIO_CONTENT_CREATION_TEST_CREATE_MEME_ENTID"))
