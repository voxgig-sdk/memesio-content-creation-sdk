...
class StandaloneAgentBootstrapEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return StandaloneAgentBootstrapEntity(self._client, opts)
    ...
    def data_get(self) -> StandaloneAgentBootstrap:
    ...
    def match_get(self) -> StandaloneAgentBootstrap:
    ...
    def create(self, reqdata: StandaloneAgentBootstrapCreateData, ctrl=None) -> StandaloneAgentBootstrap:
        utility = self._utility
