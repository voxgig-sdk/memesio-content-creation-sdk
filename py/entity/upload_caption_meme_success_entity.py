...
class UploadCaptionMemeSuccessEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UploadCaptionMemeSuccessEntity(self._client, opts)
    ...
    def data_get(self) -> UploadCaptionMemeSuccess:
    ...
    def match_get(self) -> UploadCaptionMemeSuccess:
    ...
    def create(self, reqdata: UploadCaptionMemeSuccessCreateData, ctrl=None) -> UploadCaptionMemeSuccess:
        utility = self._utility
