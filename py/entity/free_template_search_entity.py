...
class FreeTemplateSearchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FreeTemplateSearchEntity(self._client, opts)
    ...
    def data_get(self) -> FreeTemplateSearch:
    ...
    def match_get(self) -> FreeTemplateSearch:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[FreeTemplateSearch]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.FreeTemplateSearch().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
