...
class CreateMemeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CreateMemeEntity(self._client, opts)
    ...
    def create(self, reqdata: CreateMemeCreateData, ctrl=None) -> CreateMeme:
        utility = self._utility
