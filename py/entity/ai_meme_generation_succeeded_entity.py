...
class AiMemeGenerationSucceededEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AiMemeGenerationSucceededEntity(self._client, opts)
    ...
    def data_get(self) -> AiMemeGenerationSucceeded:
    ...
    def match_get(self) -> AiMemeGenerationSucceeded:
    ...
    def create(self, reqdata: AiMemeGenerationSucceededCreateData, ctrl=None) -> AiMemeGenerationSucceeded:
        utility = self._utility
