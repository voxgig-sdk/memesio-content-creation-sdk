...
class TemplateSearchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TemplateSearchEntity(self._client, opts)
    ...
    def data_get(self) -> TemplateSearch:
    ...
    def match_get(self) -> TemplateSearch:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TemplateSearch]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TemplateSearch().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
