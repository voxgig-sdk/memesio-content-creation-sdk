...
class PublicTemplateMediaItemEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PublicTemplateMediaItemEntity(self._client, opts)
    ...
    def data_get(self) -> PublicTemplateMediaItem:
    ...
    def match_get(self) -> PublicTemplateMediaItem:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PublicTemplateMediaItem:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PublicTemplateMediaItem().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
