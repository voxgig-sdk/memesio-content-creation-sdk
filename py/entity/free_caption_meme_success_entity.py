...
class FreeCaptionMemeSuccessEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FreeCaptionMemeSuccessEntity(self._client, opts)
    ...
    def data_get(self) -> FreeCaptionMemeSuccess:
    ...
    def match_get(self) -> FreeCaptionMemeSuccess:
    ...
    def create(self, reqdata: FreeCaptionMemeSuccessCreateData, ctrl=None) -> FreeCaptionMemeSuccess:
        utility = self._utility
