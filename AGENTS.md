# MemesioContentCreation SDK — Agent Guide
...
**Entities** (27): `Agent`, `AgentInfra`, `AiCaption`, `AiJob`, `AiMemeGenerationSucceeded`, `AiProvider`, `Analytics`, `Auth`, `Billing`, `Collaboration`, `Compliance`, `CreateMeme`, `DeveloperApi`, `FreeCaptionMemeSuccess`, `FreeTemplateSearch`, `Generate`, `Growth`, `ListMeme`, `Media`, `Meme`, `PublicTemplateMediaItem`, `StandaloneAgentBootstrap`, `Template`, `TemplateSearch`, `TrendAlert`, `UploadCaptionMemeSuccess`, `Video`.
