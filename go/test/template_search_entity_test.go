...
func TestTemplateSearchEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		templateSearchRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.template_search")))
...
func template_searchBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("MEMESIO_CONTENT_CREATION_TEST_TEMPLATE_SEARCH_ENTID")
	...
	idmapResolved := core.ToMapAny(env["MEMESIO_CONTENT_CREATION_TEST_TEMPLATE_SEARCH_ENTID"])
