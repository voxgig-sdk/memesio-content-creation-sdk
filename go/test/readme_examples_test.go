...
const testSeed = `map[string]any{"entity": map[string]any{"agent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "agent_infra": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ai_caption": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ai_job": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ai_meme_generation_succeeded": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ai_provider": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "analytics": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "auth": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "billing": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "collaboration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "compliance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "create_meme": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "developer_api": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "free_caption_meme_success": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "free_template_search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "generate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "growth": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list_meme": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "media": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "meme": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "public_template_media_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "standalone_agent_bootstrap": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "template_search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "trend_alert": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "upload_caption_meme_success": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "video": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
