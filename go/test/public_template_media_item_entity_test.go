...
func TestPublicTemplateMediaItemEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set MEMESIO_CONTENT_CREATION_TEST_PUBLIC_TEMPLATE_MEDIA_ITEM_ENTID JSON to run live")
			return
		}
		client := setup.client
		...
		publicTemplateMediaItemRef01DataDt0LoadResult := core.ToMapAny(entityData(publicTemplateMediaItemRef01DataDt0Loaded))
...
func public_template_media_itemBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("MEMESIO_CONTENT_CREATION_TEST_PUBLIC_TEMPLATE_MEDIA_ITEM_ENTID")
