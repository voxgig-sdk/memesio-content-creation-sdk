...
import "github.com/voxgig-sdk/memesio-content-creation-sdk/go/core"
...
func makeErrorUtil(ctx *core.Context, err error) (any, error) {
	...
	sdkErr := &core.MemesioContentCreationError{
	...
	if se, ok := err.(*core.MemesioContentCreationError); ok {
		sdkErr.Code = se.Code
	}
