...
type DeveloperApiEntity struct {
	name    string
...
func NewDeveloperApiEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *DeveloperApiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeveloperApiEntity) GetName() string { return e.name }
...
func (e *DeveloperApiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeveloperApiEntity) Deleted() bool {
	return e.deleted
}


func (e *DeveloperApiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeveloperApiEntity(e.client, opts)
}

func (e *DeveloperApiEntity) Data(args ...any) any {
...
func (e *DeveloperApiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeveloperApi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeveloperApiEntity) DataTyped(data ...DeveloperApi) DeveloperApi {
	if len(data) > 0 {
		return typedFrom[DeveloperApi](e.Data(asMap(data[0])))
	}
	return typedFrom[DeveloperApi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeveloperApi (all fields
// optional at the wire level).
func (e *DeveloperApiEntity) MatchTyped(match ...DeveloperApi) DeveloperApi {
	if len(match) > 0 {
		return typedFrom[DeveloperApi](e.Match(asMap(match[0])))
	}
	return typedFrom[DeveloperApi](e.Match())
}
...
func (e *DeveloperApiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeveloperApiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeveloperApiLoadMatch and returns an DeveloperApi. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DeveloperApiEntity) LoadTyped(reqmatch DeveloperApiLoadMatch, ctrl map[string]any) (DeveloperApi, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DeveloperApi{}, err
	}
	return typedFrom[DeveloperApi](res), nil
}



func (e *DeveloperApiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DeveloperApiEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// DeveloperApiCreateData and returns an DeveloperApi. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DeveloperApiEntity) CreateTyped(reqdata DeveloperApiCreateData, ctrl map[string]any) (DeveloperApi, error) {
...
func (e *DeveloperApiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeveloperApiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeveloperApiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
