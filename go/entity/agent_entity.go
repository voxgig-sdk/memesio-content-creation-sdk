...
func NewAgentEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *AgentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AgentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AgentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AgentCreateData and returns an Agent. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AgentEntity) CreateTyped(reqdata AgentCreateData, ctrl map[string]any) (Agent, error) {
...
func (e *AgentEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// AgentUpdateData and returns an Agent. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *AgentEntity) UpdateTyped(reqdata AgentUpdateData, ctrl map[string]any) (Agent, error) {
