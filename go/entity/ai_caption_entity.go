...
func NewAiCaptionEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *AiCaptionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AiCaptionEntity) GetName() string { return e.name }
...
func (e *AiCaptionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AiCaptionEntity) Deleted() bool {
	return e.deleted
}


func (e *AiCaptionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAiCaptionEntity(e.client, opts)
}

func (e *AiCaptionEntity) Data(args ...any) any {
...
func (e *AiCaptionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AiCaption; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AiCaptionEntity) DataTyped(data ...AiCaption) AiCaption {
	if len(data) > 0 {
		return typedFrom[AiCaption](e.Data(asMap(data[0])))
	}
	return typedFrom[AiCaption](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AiCaption (all fields
// optional at the wire level).
func (e *AiCaptionEntity) MatchTyped(match ...AiCaption) AiCaption {
	if len(match) > 0 {
		return typedFrom[AiCaption](e.Match(asMap(match[0])))
	}
	return typedFrom[AiCaption](e.Match())
}
...
func (e *AiCaptionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AiCaptionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AiCaptionLoadMatch and returns an AiCaption. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AiCaptionEntity) LoadTyped(reqmatch AiCaptionLoadMatch, ctrl map[string]any) (AiCaption, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return AiCaption{}, err
	}
	return typedFrom[AiCaption](res), nil
}



func (e *AiCaptionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AiCaptionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AiCaptionCreateData and returns an AiCaption. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AiCaptionEntity) CreateTyped(reqdata AiCaptionCreateData, ctrl map[string]any) (AiCaption, error) {
...
func (e *AiCaptionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AiCaptionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AiCaptionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
