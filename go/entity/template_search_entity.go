...
type TemplateSearchEntity struct {
	name    string
...
func NewTemplateSearchEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *TemplateSearchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TemplateSearchEntity) GetName() string { return e.name }
...
func (e *TemplateSearchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TemplateSearchEntity) Deleted() bool {
	return e.deleted
}


func (e *TemplateSearchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTemplateSearchEntity(e.client, opts)
}

func (e *TemplateSearchEntity) Data(args ...any) any {
...
func (e *TemplateSearchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TemplateSearch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TemplateSearchEntity) DataTyped(data ...TemplateSearch) TemplateSearch {
	if len(data) > 0 {
		return typedFrom[TemplateSearch](e.Data(asMap(data[0])))
	}
	return typedFrom[TemplateSearch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TemplateSearch (all fields
// optional at the wire level).
func (e *TemplateSearchEntity) MatchTyped(match ...TemplateSearch) TemplateSearch {
	if len(match) > 0 {
		return typedFrom[TemplateSearch](e.Match(asMap(match[0])))
	}
	return typedFrom[TemplateSearch](e.Match())
}
...
func (e *TemplateSearchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TemplateSearchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TemplateSearchEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TemplateSearchListMatch and returns []TemplateSearch. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TemplateSearchEntity) ListTyped(reqmatch TemplateSearchListMatch, ctrl map[string]any) ([]TemplateSearch, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TemplateSearch](res), nil
}



func (e *TemplateSearchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TemplateSearchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TemplateSearchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TemplateSearchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
