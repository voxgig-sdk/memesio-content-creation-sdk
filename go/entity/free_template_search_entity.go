...
type FreeTemplateSearchEntity struct {
	name    string
...
func NewFreeTemplateSearchEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *FreeTemplateSearchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FreeTemplateSearchEntity) GetName() string { return e.name }
...
func (e *FreeTemplateSearchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FreeTemplateSearchEntity) Deleted() bool {
	return e.deleted
}


func (e *FreeTemplateSearchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFreeTemplateSearchEntity(e.client, opts)
}

func (e *FreeTemplateSearchEntity) Data(args ...any) any {
...
func (e *FreeTemplateSearchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FreeTemplateSearch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FreeTemplateSearchEntity) DataTyped(data ...FreeTemplateSearch) FreeTemplateSearch {
	if len(data) > 0 {
		return typedFrom[FreeTemplateSearch](e.Data(asMap(data[0])))
	}
	return typedFrom[FreeTemplateSearch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FreeTemplateSearch (all fields
// optional at the wire level).
func (e *FreeTemplateSearchEntity) MatchTyped(match ...FreeTemplateSearch) FreeTemplateSearch {
	if len(match) > 0 {
		return typedFrom[FreeTemplateSearch](e.Match(asMap(match[0])))
	}
	return typedFrom[FreeTemplateSearch](e.Match())
}
...
func (e *FreeTemplateSearchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FreeTemplateSearchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *FreeTemplateSearchEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FreeTemplateSearchListMatch and returns []FreeTemplateSearch. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FreeTemplateSearchEntity) ListTyped(reqmatch FreeTemplateSearchListMatch, ctrl map[string]any) ([]FreeTemplateSearch, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[FreeTemplateSearch](res), nil
}



func (e *FreeTemplateSearchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FreeTemplateSearchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FreeTemplateSearchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FreeTemplateSearchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
