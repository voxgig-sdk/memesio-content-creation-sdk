...
func NewComplianceEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *ComplianceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ComplianceEntity) GetName() string { return e.name }
...
func (e *ComplianceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ComplianceEntity) Deleted() bool {
	return e.deleted
}


func (e *ComplianceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewComplianceEntity(e.client, opts)
}

func (e *ComplianceEntity) Data(args ...any) any {
...
func (e *ComplianceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Compliance; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ComplianceEntity) DataTyped(data ...Compliance) Compliance {
	if len(data) > 0 {
		return typedFrom[Compliance](e.Data(asMap(data[0])))
	}
	return typedFrom[Compliance](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Compliance (all fields
// optional at the wire level).
func (e *ComplianceEntity) MatchTyped(match ...Compliance) Compliance {
	if len(match) > 0 {
		return typedFrom[Compliance](e.Match(asMap(match[0])))
	}
	return typedFrom[Compliance](e.Match())
}
...
func (e *ComplianceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ComplianceEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ComplianceLoadMatch and returns an Compliance. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ComplianceEntity) LoadTyped(reqmatch ComplianceLoadMatch, ctrl map[string]any) (Compliance, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Compliance{}, err
	}
	return typedFrom[Compliance](res), nil
}



func (e *ComplianceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ComplianceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ComplianceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ComplianceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ComplianceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
