...
func NewCollaborationEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *CollaborationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CollaborationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CollaborationLoadMatch and returns an Collaboration. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CollaborationEntity) LoadTyped(reqmatch CollaborationLoadMatch, ctrl map[string]any) (Collaboration, error) {
...
func (e *CollaborationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CollaborationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CollaborationCreateData and returns an Collaboration. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CollaborationEntity) CreateTyped(reqdata CollaborationCreateData, ctrl map[string]any) (Collaboration, error) {
...
func (e *CollaborationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
