...
func NewAiProviderEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *AiProviderEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AiProviderEntity) GetName() string { return e.name }
...
func (e *AiProviderEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AiProviderEntity) Deleted() bool {
	return e.deleted
}


func (e *AiProviderEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAiProviderEntity(e.client, opts)
}

func (e *AiProviderEntity) Data(args ...any) any {
...
func (e *AiProviderEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AiProvider; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AiProviderEntity) DataTyped(data ...AiProvider) AiProvider {
	if len(data) > 0 {
		return typedFrom[AiProvider](e.Data(asMap(data[0])))
	}
	return typedFrom[AiProvider](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AiProvider (all fields
// optional at the wire level).
func (e *AiProviderEntity) MatchTyped(match ...AiProvider) AiProvider {
	if len(match) > 0 {
		return typedFrom[AiProvider](e.Match(asMap(match[0])))
	}
	return typedFrom[AiProvider](e.Match())
}
...
func (e *AiProviderEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AiProviderEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AiProviderLoadMatch and returns an AiProvider. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AiProviderEntity) LoadTyped(reqmatch AiProviderLoadMatch, ctrl map[string]any) (AiProvider, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return AiProvider{}, err
	}
	return typedFrom[AiProvider](res), nil
}



func (e *AiProviderEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AiProviderEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AiProviderCreateData and returns an AiProvider. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AiProviderEntity) CreateTyped(reqdata AiProviderCreateData, ctrl map[string]any) (AiProvider, error) {
...
func (e *AiProviderEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AiProviderEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AiProviderEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
