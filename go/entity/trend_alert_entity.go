...
func NewTrendAlertEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *TrendAlertEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TrendAlertEntity) GetName() string { return e.name }
...
func (e *TrendAlertEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TrendAlertEntity) Deleted() bool {
	return e.deleted
}


func (e *TrendAlertEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTrendAlertEntity(e.client, opts)
}

func (e *TrendAlertEntity) Data(args ...any) any {
...
func (e *TrendAlertEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TrendAlert; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TrendAlertEntity) DataTyped(data ...TrendAlert) TrendAlert {
	if len(data) > 0 {
		return typedFrom[TrendAlert](e.Data(asMap(data[0])))
	}
	return typedFrom[TrendAlert](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TrendAlert (all fields
// optional at the wire level).
func (e *TrendAlertEntity) MatchTyped(match ...TrendAlert) TrendAlert {
	if len(match) > 0 {
		return typedFrom[TrendAlert](e.Match(asMap(match[0])))
	}
	return typedFrom[TrendAlert](e.Match())
}
...
func (e *TrendAlertEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TrendAlertEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TrendAlertLoadMatch and returns an TrendAlert. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TrendAlertEntity) LoadTyped(reqmatch TrendAlertLoadMatch, ctrl map[string]any) (TrendAlert, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return TrendAlert{}, err
	}
	return typedFrom[TrendAlert](res), nil
}



func (e *TrendAlertEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TrendAlertEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// TrendAlertCreateData and returns an TrendAlert. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TrendAlertEntity) CreateTyped(reqdata TrendAlertCreateData, ctrl map[string]any) (TrendAlert, error) {
...
func (e *TrendAlertEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TrendAlertEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TrendAlertEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
