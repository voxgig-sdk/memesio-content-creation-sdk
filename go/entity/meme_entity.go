...
func NewMemeEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *MemeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MemeEntity) GetName() string { return e.name }
...
func (e *MemeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MemeEntity) Deleted() bool {
	return e.deleted
}


func (e *MemeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMemeEntity(e.client, opts)
}

func (e *MemeEntity) Data(args ...any) any {
...
func (e *MemeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Meme; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MemeEntity) DataTyped(data ...Meme) Meme {
	if len(data) > 0 {
		return typedFrom[Meme](e.Data(asMap(data[0])))
	}
	return typedFrom[Meme](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Meme (all fields
// optional at the wire level).
func (e *MemeEntity) MatchTyped(match ...Meme) Meme {
	if len(match) > 0 {
		return typedFrom[Meme](e.Match(asMap(match[0])))
	}
	return typedFrom[Meme](e.Match())
}
...
func (e *MemeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MemeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MemeLoadMatch and returns an Meme. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MemeEntity) LoadTyped(reqmatch MemeLoadMatch, ctrl map[string]any) (Meme, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Meme{}, err
	}
	return typedFrom[Meme](res), nil
}



func (e *MemeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MemeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MemeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *MemeEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// MemeRemoveMatch and returns an Meme. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *MemeEntity) RemoveTyped(reqmatch MemeRemoveMatch, ctrl map[string]any) (Meme, error) {
...
func (e *MemeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
