...
type PublicTemplateMediaItemEntity struct {
	name    string
...
func NewPublicTemplateMediaItemEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *PublicTemplateMediaItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &PublicTemplateMediaItemEntity{
...
func (e *PublicTemplateMediaItemEntity) GetName() string { return e.name }
...
func (e *PublicTemplateMediaItemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PublicTemplateMediaItemEntity) Deleted() bool {
	return e.deleted
}


func (e *PublicTemplateMediaItemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPublicTemplateMediaItemEntity(e.client, opts)
}

func (e *PublicTemplateMediaItemEntity) Data(args ...any) any {
...
func (e *PublicTemplateMediaItemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PublicTemplateMediaItem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PublicTemplateMediaItemEntity) DataTyped(data ...PublicTemplateMediaItem) PublicTemplateMediaItem {
	if len(data) > 0 {
		return typedFrom[PublicTemplateMediaItem](e.Data(asMap(data[0])))
	}
	return typedFrom[PublicTemplateMediaItem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PublicTemplateMediaItem (all fields
// optional at the wire level).
func (e *PublicTemplateMediaItemEntity) MatchTyped(match ...PublicTemplateMediaItem) PublicTemplateMediaItem {
	if len(match) > 0 {
		return typedFrom[PublicTemplateMediaItem](e.Match(asMap(match[0])))
	}
	return typedFrom[PublicTemplateMediaItem](e.Match())
}
...
func (e *PublicTemplateMediaItemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PublicTemplateMediaItemEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PublicTemplateMediaItemLoadMatch and returns an PublicTemplateMediaItem. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PublicTemplateMediaItemEntity) LoadTyped(reqmatch PublicTemplateMediaItemLoadMatch, ctrl map[string]any) (PublicTemplateMediaItem, error) {
...
func (e *PublicTemplateMediaItemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *PublicTemplateMediaItemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PublicTemplateMediaItemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
