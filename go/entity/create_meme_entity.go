...
func NewCreateMemeEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *CreateMemeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CreateMemeEntity) GetName() string { return e.name }
...
func (e *CreateMemeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CreateMemeEntity) Deleted() bool {
	return e.deleted
}


func (e *CreateMemeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCreateMemeEntity(e.client, opts)
}

func (e *CreateMemeEntity) Data(args ...any) any {
...
func (e *CreateMemeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CreateMeme; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CreateMemeEntity) DataTyped(data ...CreateMeme) CreateMeme {
	if len(data) > 0 {
		return typedFrom[CreateMeme](e.Data(asMap(data[0])))
	}
	return typedFrom[CreateMeme](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CreateMeme (all fields
// optional at the wire level).
func (e *CreateMemeEntity) MatchTyped(match ...CreateMeme) CreateMeme {
	if len(match) > 0 {
		return typedFrom[CreateMeme](e.Match(asMap(match[0])))
	}
	return typedFrom[CreateMeme](e.Match())
}
...
func (e *CreateMemeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CreateMemeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CreateMemeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CreateMemeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CreateMemeCreateData and returns an CreateMeme. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CreateMemeEntity) CreateTyped(reqdata CreateMemeCreateData, ctrl map[string]any) (CreateMeme, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CreateMeme{}, err
	}
	return typedFrom[CreateMeme](res), nil
}



func (e *CreateMemeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CreateMemeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CreateMemeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
