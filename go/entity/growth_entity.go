...
func NewGrowthEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *GrowthEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GrowthEntity) GetName() string { return e.name }
...
func (e *GrowthEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GrowthEntity) Deleted() bool {
	return e.deleted
}


func (e *GrowthEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGrowthEntity(e.client, opts)
}

func (e *GrowthEntity) Data(args ...any) any {
...
func (e *GrowthEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Growth; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GrowthEntity) DataTyped(data ...Growth) Growth {
	if len(data) > 0 {
		return typedFrom[Growth](e.Data(asMap(data[0])))
	}
	return typedFrom[Growth](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Growth (all fields
// optional at the wire level).
func (e *GrowthEntity) MatchTyped(match ...Growth) Growth {
	if len(match) > 0 {
		return typedFrom[Growth](e.Match(asMap(match[0])))
	}
	return typedFrom[Growth](e.Match())
}
...
func (e *GrowthEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GrowthEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GrowthLoadMatch and returns an Growth. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GrowthEntity) LoadTyped(reqmatch GrowthLoadMatch, ctrl map[string]any) (Growth, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Growth{}, err
	}
	return typedFrom[Growth](res), nil
}



func (e *GrowthEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GrowthEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GrowthCreateData and returns an Growth. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GrowthEntity) CreateTyped(reqdata GrowthCreateData, ctrl map[string]any) (Growth, error) {
...
func (e *GrowthEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GrowthEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GrowthEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
