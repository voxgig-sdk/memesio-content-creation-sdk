...
func NewListMemeEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *ListMemeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ListMemeEntity) GetName() string { return e.name }
...
func (e *ListMemeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ListMemeEntity) Deleted() bool {
	return e.deleted
}


func (e *ListMemeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewListMemeEntity(e.client, opts)
}

func (e *ListMemeEntity) Data(args ...any) any {
...
func (e *ListMemeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ListMeme; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ListMemeEntity) DataTyped(data ...ListMeme) ListMeme {
	if len(data) > 0 {
		return typedFrom[ListMeme](e.Data(asMap(data[0])))
	}
	return typedFrom[ListMeme](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ListMeme (all fields
// optional at the wire level).
func (e *ListMemeEntity) MatchTyped(match ...ListMeme) ListMeme {
	if len(match) > 0 {
		return typedFrom[ListMeme](e.Match(asMap(match[0])))
	}
	return typedFrom[ListMeme](e.Match())
}
...
func (e *ListMemeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ListMemeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ListMemeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ListMemeListMatch and returns []ListMeme. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ListMemeEntity) ListTyped(reqmatch ListMemeListMatch, ctrl map[string]any) ([]ListMeme, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ListMeme](res), nil
}



func (e *ListMemeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ListMemeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ListMemeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ListMemeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
