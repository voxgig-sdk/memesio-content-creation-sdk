...
func NewAiJobEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *AiJobEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AiJobEntity) GetName() string { return e.name }
...
func (e *AiJobEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AiJobEntity) Deleted() bool {
	return e.deleted
}


func (e *AiJobEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAiJobEntity(e.client, opts)
}

func (e *AiJobEntity) Data(args ...any) any {
...
func (e *AiJobEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AiJob; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AiJobEntity) DataTyped(data ...AiJob) AiJob {
	if len(data) > 0 {
		return typedFrom[AiJob](e.Data(asMap(data[0])))
	}
	return typedFrom[AiJob](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AiJob (all fields
// optional at the wire level).
func (e *AiJobEntity) MatchTyped(match ...AiJob) AiJob {
	if len(match) > 0 {
		return typedFrom[AiJob](e.Match(asMap(match[0])))
	}
	return typedFrom[AiJob](e.Match())
}
...
func (e *AiJobEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AiJobEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AiJobLoadMatch and returns an AiJob. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AiJobEntity) LoadTyped(reqmatch AiJobLoadMatch, ctrl map[string]any) (AiJob, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return AiJob{}, err
	}
	return typedFrom[AiJob](res), nil
}



func (e *AiJobEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AiJobEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AiJobCreateData and returns an AiJob. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AiJobEntity) CreateTyped(reqdata AiJobCreateData, ctrl map[string]any) (AiJob, error) {
...
func (e *AiJobEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AiJobEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AiJobEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
