...
func NewAgentInfraEntity(client *core.MemesioContentCreationSDK, entopts map[string]any) *AgentInfraEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AgentInfraEntity) GetName() string { return e.name }
...
func (e *AgentInfraEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AgentInfraEntity) Deleted() bool {
	return e.deleted
}


func (e *AgentInfraEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAgentInfraEntity(e.client, opts)
}

func (e *AgentInfraEntity) Data(args ...any) any {
...
func (e *AgentInfraEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AgentInfra; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AgentInfraEntity) DataTyped(data ...AgentInfra) AgentInfra {
	if len(data) > 0 {
		return typedFrom[AgentInfra](e.Data(asMap(data[0])))
	}
	return typedFrom[AgentInfra](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AgentInfra (all fields
// optional at the wire level).
func (e *AgentInfraEntity) MatchTyped(match ...AgentInfra) AgentInfra {
	if len(match) > 0 {
		return typedFrom[AgentInfra](e.Match(asMap(match[0])))
	}
	return typedFrom[AgentInfra](e.Match())
}
...
func (e *AgentInfraEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AgentInfraEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AgentInfraLoadMatch and returns an AgentInfra. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AgentInfraEntity) LoadTyped(reqmatch AgentInfraLoadMatch, ctrl map[string]any) (AgentInfra, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return AgentInfra{}, err
	}
	return typedFrom[AgentInfra](res), nil
}



func (e *AgentInfraEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AgentInfraEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AgentInfraCreateData and returns an AgentInfra. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AgentInfraEntity) CreateTyped(reqdata AgentInfraCreateData, ctrl map[string]any) (AgentInfra, error) {
...
func (e *AgentInfraEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *AgentInfraEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// AgentInfraRemoveMatch and returns an AgentInfra. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AgentInfraEntity) RemoveTyped(reqmatch AgentInfraRemoveMatch, ctrl map[string]any) (AgentInfra, error) {
...
func (e *AgentInfraEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
