// Command MemesioContentCreation-cli is a CLI + REPL for the MemesioContentCreation SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      MEMESIO_CONTENT_CREATION_APIKEY (api key), MEMESIO_CONTENT_CREATION_BASE (base url override)")
