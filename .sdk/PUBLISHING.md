...
|---|---|---|
| `ts/` | @voxgig-sdk/memesio-content-creation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/memesio-content-creation-sdk \
      --repository voxgig-sdk/memesio-content-creation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/memesio-content-creation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/memesio-content-creation-sdk --id=<id>` removes it.
