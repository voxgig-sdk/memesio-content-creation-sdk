# MemesioContentCreation SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # MemesioContentCreationSDK.new, not MemesioContentCreationSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    MemesioContentCreationSDK.new(opts)
  end
