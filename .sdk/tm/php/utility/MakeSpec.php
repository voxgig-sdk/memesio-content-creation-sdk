...
// MemesioContentCreation SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class MemesioContentCreationMakeSpec
{
    public static function call(MemesioContentCreationContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = MemesioContentCreationGraphql::CONTENT_TYPE;
        } else {
