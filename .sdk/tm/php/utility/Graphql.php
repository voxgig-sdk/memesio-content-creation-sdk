...
// MemesioContentCreation SDK utility: graphql
//
...
class MemesioContentCreationGraphql
{
    ...
    // equivalent.
    public static function body(MemesioContentCreationContext $ctx): mixed
    {
    ...
    public static function errors(MemesioContentCreationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
