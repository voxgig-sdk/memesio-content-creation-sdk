...
// MemesioContentCreation SDK utility: prepare_method

class MemesioContentCreationPrepareMethod
{
    ...
    public static function call(MemesioContentCreationContext $ctx): string
    {
