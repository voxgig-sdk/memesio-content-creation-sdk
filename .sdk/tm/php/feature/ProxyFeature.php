...
// MemesioContentCreation SDK proxy feature
...
class MemesioContentCreationProxyFeature extends MemesioContentCreationBaseFeature
{
    ...
    public function init(MemesioContentCreationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MemesioContentCreationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
