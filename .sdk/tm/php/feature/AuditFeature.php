...
// MemesioContentCreation SDK audit feature
...
class MemesioContentCreationAuditFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _emit(MemesioContentCreationContext $ctx, string $outcome): void
    {
