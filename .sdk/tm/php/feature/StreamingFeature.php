...
// MemesioContentCreation SDK streaming feature
...
class MemesioContentCreationStreamingFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _iterate(MemesioContentCreationResult $result): \Generator
    {
    ...
    private function _streamable(MemesioContentCreationContext $ctx): bool
    {
