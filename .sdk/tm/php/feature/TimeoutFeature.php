...
// MemesioContentCreation SDK timeout feature
...
class MemesioContentCreationTimeoutFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _with_timeout(MemesioContentCreationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MemesioContentCreationContext $_ctx, float $ms): void
    {
        $client = $this->client;
