...
// MemesioContentCreation SDK ratelimit feature
...
class MemesioContentCreationRatelimitFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _acquire(MemesioContentCreationContext $ctx): void
    {
    ...
    private function _track(MemesioContentCreationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
