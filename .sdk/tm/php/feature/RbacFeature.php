...
// MemesioContentCreation SDK rbac feature
...
class MemesioContentCreationRbacFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _required(MemesioContentCreationContext $ctx): ?string
    {
    ...
    private function _reject(MemesioContentCreationContext $ctx, string $required): void
    {
    ...
    private function _track(MemesioContentCreationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
