...
class FreeCaptionMemeSuccessEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "free_caption_meme_success";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new FreeCaptionMemeSuccessEntity($this->_client, $opts);
    }

    /**
     * @param FreeCaptionMemeSuccess|array $args FreeCaptionMemeSuccess data (assoc-array) to store.
     */
    ...
    /**
     * @return FreeCaptionMemeSuccess|array The current FreeCaptionMemeSuccess data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FreeCaptionMemeSuccess fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FreeCaptionMemeSuccess fields).
     */
    ...
    /**
     * Create a new FreeCaptionMemeSuccess.
     *
     * @param FreeCaptionMemeSuccessCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FreeCaptionMemeSuccessCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FreeCaptionMemeSuccess|array The created FreeCaptionMemeSuccess as an assoc-array at the
