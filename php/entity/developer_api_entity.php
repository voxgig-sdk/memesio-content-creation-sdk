...
// MemesioContentCreation SDK DeveloperApi entity
...
class DeveloperApiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeveloperApiEntity($this->_client, $opts);
    }

    /**
     * @param DeveloperApi|array $args DeveloperApi data (assoc-array) to store.
     */
    ...
    /**
     * @return DeveloperApi|array The current DeveloperApi data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeveloperApi fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeveloperApi fields).
     */
    ...
    /**
     * Load a single DeveloperApi.
     *
     * @param DeveloperApiLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeveloperApiLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeveloperApi|array The loaded DeveloperApi as an assoc-array at the
    ...
    /**
     * Create a new DeveloperApi.
     *
     * @param DeveloperApiCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeveloperApiCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeveloperApi|array The created DeveloperApi as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
