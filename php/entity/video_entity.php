...
class VideoEntity
{
     ...
     * Create a new Video.
     *
     * @param VideoCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed VideoCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Video|array The created Video as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
