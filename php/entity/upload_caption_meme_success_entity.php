...
class UploadCaptionMemeSuccessEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "upload_caption_meme_success";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UploadCaptionMemeSuccessEntity($this->_client, $opts);
    }

    /**
     * @param UploadCaptionMemeSuccess|array $args UploadCaptionMemeSuccess data (assoc-array) to store.
     */
    ...
    /**
     * @return UploadCaptionMemeSuccess|array The current UploadCaptionMemeSuccess data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UploadCaptionMemeSuccess fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UploadCaptionMemeSuccess fields).
     */
    ...
    /**
     * Create a new UploadCaptionMemeSuccess.
     *
     * @param UploadCaptionMemeSuccessCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UploadCaptionMemeSuccessCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UploadCaptionMemeSuccess|array The created UploadCaptionMemeSuccess as an assoc-array at the
