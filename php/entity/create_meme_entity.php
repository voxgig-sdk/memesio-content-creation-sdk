...
class CreateMemeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CreateMemeEntity($this->_client, $opts);
    }

    /**
     * @param CreateMeme|array $args CreateMeme data (assoc-array) to store.
     */
    ...
    /**
     * @return CreateMeme|array The current CreateMeme data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CreateMeme fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CreateMeme fields).
     */
    ...
    /**
     * Create a new CreateMeme.
     *
     * @param CreateMemeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CreateMemeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CreateMeme|array The created CreateMeme as an assoc-array at the
