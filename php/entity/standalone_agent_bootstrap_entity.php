...
class StandaloneAgentBootstrapEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "standalone_agent_bootstrap";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new StandaloneAgentBootstrapEntity($this->_client, $opts);
    }

    /**
     * @param StandaloneAgentBootstrap|array $args StandaloneAgentBootstrap data (assoc-array) to store.
     */
    ...
    /**
     * @return StandaloneAgentBootstrap|array The current StandaloneAgentBootstrap data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StandaloneAgentBootstrap fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StandaloneAgentBootstrap fields).
     */
    ...
    /**
     * Create a new StandaloneAgentBootstrap.
     *
     * @param StandaloneAgentBootstrapCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StandaloneAgentBootstrapCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StandaloneAgentBootstrap|array The created StandaloneAgentBootstrap as an assoc-array at the
