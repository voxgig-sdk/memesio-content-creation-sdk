...
// MemesioContentCreation SDK Growth entity
...
class GrowthEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GrowthEntity($this->_client, $opts);
    }

    /**
     * @param Growth|array $args Growth data (assoc-array) to store.
     */
    ...
    /**
     * @return Growth|array The current Growth data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Growth fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Growth fields).
     */
    ...
    /**
     * Load a single Growth.
     *
     * @param GrowthLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GrowthLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Growth|array The loaded Growth as an assoc-array at the
     ...
     * Create a new Growth.
     *
     * @param GrowthCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GrowthCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Growth|array The created Growth as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
