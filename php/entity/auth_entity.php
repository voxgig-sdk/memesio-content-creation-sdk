...
class AuthEntity
{
     ...
     * Create a new Auth.
     *
     * @param AuthCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AuthCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Auth|array The created Auth as an assoc-array at the
