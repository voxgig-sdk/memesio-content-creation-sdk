...
// MemesioContentCreation SDK Collaboration entity
...
class CollaborationEntity
{
    ...
    /**
     * Load a single Collaboration.
     *
     * @param CollaborationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CollaborationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Collaboration|array The loaded Collaboration as an assoc-array at the
     ...
     *
     * @param CollaborationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CollaborationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Collaboration|array The created Collaboration as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
