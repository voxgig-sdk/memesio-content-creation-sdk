...
// MemesioContentCreation SDK Meme entity
...
class MemeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MemeEntity($this->_client, $opts);
    }

    /**
     * @param Meme|array $args Meme data (assoc-array) to store.
     */
    ...
    /**
     * @return Meme|array The current Meme data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Meme fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Meme fields).
     */
     ...
     * Load a single Meme.
     *
     * @param MemeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MemeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Meme|array The loaded Meme as an assoc-array at the
    ...
    /**
     * Remove an Meme matching the given criteria.
     *
     * @param MemeRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; MemeRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Meme|array The removed Meme as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
