...
// MemesioContentCreation SDK AiProvider entity
...
class AiProviderEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AiProviderEntity($this->_client, $opts);
    }

    /**
     * @param AiProvider|array $args AiProvider data (assoc-array) to store.
     */
    ...
    /**
     * @return AiProvider|array The current AiProvider data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiProvider fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiProvider fields).
     */
    ...
    /**
     * Load a single AiProvider.
     *
     * @param AiProviderLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AiProviderLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiProvider|array The loaded AiProvider as an assoc-array at the
    ...
    /**
     * Create a new AiProvider.
     *
     * @param AiProviderCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AiProviderCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiProvider|array The created AiProvider as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
