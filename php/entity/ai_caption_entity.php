...
// MemesioContentCreation SDK AiCaption entity
...
class AiCaptionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AiCaptionEntity($this->_client, $opts);
    }

    /**
     * @param AiCaption|array $args AiCaption data (assoc-array) to store.
     */
    ...
    /**
     * @return AiCaption|array The current AiCaption data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiCaption fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiCaption fields).
     */
    ...
    /**
     * Load a single AiCaption.
     *
     * @param AiCaptionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AiCaptionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiCaption|array The loaded AiCaption as an assoc-array at the
    ...
    /**
     * Create a new AiCaption.
     *
     * @param AiCaptionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AiCaptionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiCaption|array The created AiCaption as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
