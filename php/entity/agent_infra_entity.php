...
// MemesioContentCreation SDK AgentInfra entity
...
class AgentInfraEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AgentInfraEntity($this->_client, $opts);
    }

    /**
     * @param AgentInfra|array $args AgentInfra data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = MemesioContentCreationHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return AgentInfra|array The current AgentInfra data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AgentInfra fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = MemesioContentCreationHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of AgentInfra fields).
     */
    ...
    /**
     * Load a single AgentInfra.
     *
     * @param AgentInfraLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AgentInfraLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AgentInfra|array The loaded AgentInfra as an assoc-array at the
    ...
    /**
     * Create a new AgentInfra.
     *
     * @param AgentInfraCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AgentInfraCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AgentInfra|array The created AgentInfra as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an AgentInfra matching the given criteria.
     *
     * @param AgentInfraRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AgentInfraRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AgentInfra|array The removed AgentInfra as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
