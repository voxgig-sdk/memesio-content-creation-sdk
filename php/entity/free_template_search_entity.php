...
// MemesioContentCreation SDK FreeTemplateSearch entity
...
class FreeTemplateSearchEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "free_template_search";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new FreeTemplateSearchEntity($this->_client, $opts);
    }

    /**
     * @param FreeTemplateSearch|array $args FreeTemplateSearch data (assoc-array) to store.
     */
    ...
    /**
     * @return FreeTemplateSearch|array The current FreeTemplateSearch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FreeTemplateSearch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FreeTemplateSearch fields).
     */
    ...
    /**
     * List FreeTemplateSearch items matching the given filter.
     *
     * @param FreeTemplateSearchListMatch|array|null $reqmatch Match filter (any subset
     *   of FreeTemplateSearch fields) as an assoc-array; FreeTemplateSearchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FreeTemplateSearch[]|array A list of FreeTemplateSearch items as assoc-arrays at
     *   the SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
