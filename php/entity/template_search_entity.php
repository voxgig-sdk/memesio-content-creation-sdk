...
// MemesioContentCreation SDK TemplateSearch entity
...
class TemplateSearchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TemplateSearchEntity($this->_client, $opts);
    }

    /**
     * @param TemplateSearch|array $args TemplateSearch data (assoc-array) to store.
     */
    ...
    /**
     * @return TemplateSearch|array The current TemplateSearch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TemplateSearch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TemplateSearch fields).
     */
    ...
    /**
     * List TemplateSearch items matching the given filter.
     *
     * @param TemplateSearchListMatch|array|null $reqmatch Match filter (any subset
     *   of TemplateSearch fields) as an assoc-array; TemplateSearchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TemplateSearch[]|array A list of TemplateSearch items as assoc-arrays at
