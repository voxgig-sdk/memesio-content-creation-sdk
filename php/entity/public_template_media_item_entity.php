...
class PublicTemplateMediaItemEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "public_template_media_item";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PublicTemplateMediaItemEntity($this->_client, $opts);
    }

    /**
     * @param PublicTemplateMediaItem|array $args PublicTemplateMediaItem data (assoc-array) to store.
     */
    ...
    /**
     * @return PublicTemplateMediaItem|array The current PublicTemplateMediaItem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PublicTemplateMediaItem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PublicTemplateMediaItem fields).
     */
     ...
     *
     * @param PublicTemplateMediaItemLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PublicTemplateMediaItemLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PublicTemplateMediaItem|array The loaded PublicTemplateMediaItem as an assoc-array at the
