...
class AiMemeGenerationSucceededEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "ai_meme_generation_succeeded";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AiMemeGenerationSucceededEntity($this->_client, $opts);
    }

    /**
     * @param AiMemeGenerationSucceeded|array $args AiMemeGenerationSucceeded data (assoc-array) to store.
     */
    ...
    /**
     * @return AiMemeGenerationSucceeded|array The current AiMemeGenerationSucceeded data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiMemeGenerationSucceeded fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiMemeGenerationSucceeded fields).
     */
    ...
    /**
     * Create a new AiMemeGenerationSucceeded.
     *
     * @param AiMemeGenerationSucceededCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AiMemeGenerationSucceededCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiMemeGenerationSucceeded|array The created AiMemeGenerationSucceeded as an assoc-array at the
