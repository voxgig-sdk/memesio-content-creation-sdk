...
// MemesioContentCreation SDK TrendAlert entity
...
class TrendAlertEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TrendAlertEntity($this->_client, $opts);
    }

    /**
     * @param TrendAlert|array $args TrendAlert data (assoc-array) to store.
     */
    ...
    /**
     * @return TrendAlert|array The current TrendAlert data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TrendAlert fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TrendAlert fields).
     */
    ...
    /**
     * Load a single TrendAlert.
     *
     * @param TrendAlertLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TrendAlertLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TrendAlert|array The loaded TrendAlert as an assoc-array at the
    ...
    /**
     * Create a new TrendAlert.
     *
     * @param TrendAlertCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TrendAlertCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TrendAlert|array The created TrendAlert as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
