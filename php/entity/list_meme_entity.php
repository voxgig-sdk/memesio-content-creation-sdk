...
// MemesioContentCreation SDK ListMeme entity
...
class ListMemeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ListMemeEntity($this->_client, $opts);
    }

    /**
     * @param ListMeme|array $args ListMeme data (assoc-array) to store.
     */
    ...
    /**
     * @return ListMeme|array The current ListMeme data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ListMeme fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ListMeme fields).
     */
    ...
    /**
     * List ListMeme items matching the given filter.
     *
     * @param ListMemeListMatch|array|null $reqmatch Match filter (any subset
     *   of ListMeme fields) as an assoc-array; ListMemeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ListMeme[]|array A list of ListMeme items as assoc-arrays at
