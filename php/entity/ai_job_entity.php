...
// MemesioContentCreation SDK AiJob entity
...
class AiJobEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AiJobEntity($this->_client, $opts);
    }

    /**
     * @param AiJob|array $args AiJob data (assoc-array) to store.
     */
    ...
    /**
     * @return AiJob|array The current AiJob data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiJob fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiJob fields).
     */
     ...
     * Load a single AiJob.
     *
     * @param AiJobLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AiJobLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiJob|array The loaded AiJob as an assoc-array at the
     ...
     * Create a new AiJob.
     *
     * @param AiJobCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AiJobCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiJob|array The created AiJob as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
