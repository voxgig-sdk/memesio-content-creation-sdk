...
class ComplianceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ComplianceEntity($this->_client, $opts);
    }

    /**
     * @param Compliance|array $args Compliance data (assoc-array) to store.
     */
    ...
    /**
     * @return Compliance|array The current Compliance data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Compliance fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Compliance fields).
     */
    ...
    /**
     * Load a single Compliance.
     *
     * @param ComplianceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ComplianceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Compliance|array The loaded Compliance as an assoc-array at the
