...
class AgentEntity
{
     ...
     * Create a new Agent.
     *
     * @param AgentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AgentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Agent|array The created Agent as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
     ...
     *
     * @param AgentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AgentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Agent|array The updated Agent as an assoc-array at the
     *   SDK boundary; throws MemesioContentCreationError on failure (item-5 convention).
     */
