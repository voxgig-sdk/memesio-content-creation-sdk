...
// MemesioContentCreation SDK utility type

class MemesioContentCreationUtility
{
    ...
    public static function copy(MemesioContentCreationUtility $src): MemesioContentCreationUtility
    {
        $u = new MemesioContentCreationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
