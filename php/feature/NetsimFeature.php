...
// MemesioContentCreation SDK netsim feature
...
class MemesioContentCreationNetsimFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _simulate(MemesioContentCreationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MemesioContentCreationContext $ctx, array $applied): void
    {
        $client = $this->client;
