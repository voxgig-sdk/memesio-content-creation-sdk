...
// MemesioContentCreation SDK metrics feature
...
class MemesioContentCreationMetricsFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _record(MemesioContentCreationContext $ctx, bool $ok): void
    {
