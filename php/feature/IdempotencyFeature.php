...
// MemesioContentCreation SDK idempotency feature
...
class MemesioContentCreationIdempotencyFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _mutating(MemesioContentCreationContext $ctx): bool
    {
