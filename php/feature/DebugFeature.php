...
// MemesioContentCreation SDK debug feature
...
class MemesioContentCreationDebugFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _finish(MemesioContentCreationContext $ctx, bool $ok): void
    {
