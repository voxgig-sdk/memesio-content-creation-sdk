...
// MemesioContentCreation SDK paging feature
...
class MemesioContentCreationPagingFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _is_list(MemesioContentCreationContext $ctx): bool
    {
