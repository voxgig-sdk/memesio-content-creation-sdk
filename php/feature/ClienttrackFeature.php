...
// MemesioContentCreation SDK clienttrack feature
...
class MemesioContentCreationClienttrackFeature extends MemesioContentCreationBaseFeature
{
    ...
    public function PostConstruct(MemesioContentCreationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MemesioContentCreation-SDK';
