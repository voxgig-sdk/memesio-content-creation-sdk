...
// MemesioContentCreation SDK cache feature
...
class MemesioContentCreationCacheFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _through(MemesioContentCreationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
