...
// MemesioContentCreation SDK telemetry feature
...
class MemesioContentCreationTelemetryFeature extends MemesioContentCreationBaseFeature
{
    ...
    private function _close(MemesioContentCreationContext $ctx, bool $ok): void
    {
