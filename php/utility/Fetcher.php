...
// MemesioContentCreation SDK utility: fetcher

class MemesioContentCreationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MemesioContentCreationSDK/1.0)';
    ...
    public static function call(MemesioContentCreationContext $ctx, string $fullurl, array $fetchdef): array
    {
