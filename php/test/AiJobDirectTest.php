...
class AiJobDirectTest extends TestCase
{
    public function test_direct_load_ai_job(): void
    {
        $setup = ai_job_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ai_job", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
