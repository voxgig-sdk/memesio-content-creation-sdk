...
class TemplateSearchDirectTest extends TestCase
{
    public function test_direct_list_template_search(): void
    {
        $setup = template_search_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-template_search", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
