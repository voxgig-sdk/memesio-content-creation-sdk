...
class MemeDirectTest extends TestCase
{
    public function test_direct_load_meme(): void
    {
        $setup = meme_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-meme", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
