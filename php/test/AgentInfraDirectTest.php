...
class AgentInfraDirectTest extends TestCase
{
    public function test_direct_load_agent_infra(): void
    {
        $setup = agent_infra_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-agent_infra", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
