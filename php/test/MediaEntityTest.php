...
class MediaEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MEMESIOCONTENTCREATION_TEST_MEDIA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function media_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MEMESIOCONTENTCREATION_TEST_MEDIA_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["MEMESIOCONTENTCREATION_TEST_MEDIA_ENTID"]);
