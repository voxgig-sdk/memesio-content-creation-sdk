...
class AgentEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MEMESIOCONTENTCREATION_TEST_AGENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $agent_ref01_resdata_up0 = Helpers::to_map($agent_ref01_resdata_up0_result);
...
function agent_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MEMESIOCONTENTCREATION_TEST_AGENT_ENTID");
