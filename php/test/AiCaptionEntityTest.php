...
class AiCaptionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MEMESIO_CONTENT_CREATION_TEST_AI_CAPTION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $ai_caption_ref01_data = Helpers::to_map(is_object($ai_caption_ref01_data_result) && method_exists($ai_caption_ref01_data_result, 'data_get') ? $ai_caption_ref01_data_result->data_get() : $ai_caption_ref01_data_result);
...
function ai_caption_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MEMESIO_CONTENT_CREATION_TEST_AI_CAPTION_ENTID");
