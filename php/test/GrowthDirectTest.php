...
class GrowthDirectTest extends TestCase
{
    public function test_direct_load_growth(): void
    {
        $setup = growth_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-growth", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
