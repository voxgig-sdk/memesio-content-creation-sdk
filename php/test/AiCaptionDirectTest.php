...
class AiCaptionDirectTest extends TestCase
{
    public function test_direct_load_ai_caption(): void
    {
        $setup = ai_caption_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ai_caption", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
