...
class CollaborationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MEMESIOCONTENTCREATION_TEST_COLLABORATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function collaboration_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MEMESIOCONTENTCREATION_TEST_COLLABORATION_ENTID");
