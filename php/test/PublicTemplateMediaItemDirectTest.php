...
class PublicTemplateMediaItemDirectTest extends TestCase
{
    public function test_direct_load_public_template_media_item(): void
    {
        $setup = public_template_media_item_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-public_template_media_item", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
