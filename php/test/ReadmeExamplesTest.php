...
// MemesioContentCreation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MemesioContentCreationSDK::test)
...
{
    private const SDK_CLASS = 'MemesioContentCreationSDK';
    ...
    private const SDK_BASE = 'memesiocontentcreation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../memesiocontentcreation_sdk.php';
