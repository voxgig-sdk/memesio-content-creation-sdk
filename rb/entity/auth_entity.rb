# MemesioContentCreation SDK Auth entity
...
class AuthEntity
  ...
  # @return [Auth, Hash] the current Auth data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Auth fields)
  def match_get
  ...
  # Create a new Auth.
  #
  # @param reqdata [AuthCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Auth, Hash] the created Auth; raises MemesioContentCreationError on failure
