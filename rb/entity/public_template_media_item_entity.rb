...
class PublicTemplateMediaItemEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "public_template_media_item"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    PublicTemplateMediaItemEntity.new(@_client, opts)
  end
  ...
  # @return [PublicTemplateMediaItem, Hash] the current PublicTemplateMediaItem data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PublicTemplateMediaItem fields)
  def match_get
  ...
  # Load a single PublicTemplateMediaItem.
  #
  # @param reqmatch [PublicTemplateMediaItemLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PublicTemplateMediaItem.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PublicTemplateMediaItem, Hash] the loaded PublicTemplateMediaItem; raises MemesioContentCreationError on failure
  ...
  #
  # @param reqdata [PublicTemplateMediaItemCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PublicTemplateMediaItem, Hash] the created PublicTemplateMediaItem; raises MemesioContentCreationError on failure
