...
class ComplianceEntity
  ...
  def make
    opts = @_entopts.dup
    ComplianceEntity.new(@_client, opts)
  end
  ...
  # @return [Compliance, Hash] the current Compliance data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Compliance fields)
  def match_get
  ...
  #
  # @param reqmatch [ComplianceLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Compliance.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Compliance, Hash] the loaded Compliance; raises MemesioContentCreationError on failure
