...
class AiMemeGenerationSucceededEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "ai_meme_generation_succeeded"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    AiMemeGenerationSucceededEntity.new(@_client, opts)
  end
  ...
  # @return [AiMemeGenerationSucceeded, Hash] the current AiMemeGenerationSucceeded data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AiMemeGenerationSucceeded fields)
  def match_get
  ...
  #
  # @param reqdata [AiMemeGenerationSucceededCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AiMemeGenerationSucceeded, Hash] the created AiMemeGenerationSucceeded; raises MemesioContentCreationError on failure
