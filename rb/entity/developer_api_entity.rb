...
class DeveloperApiEntity
  ...
  def make
    opts = @_entopts.dup
    DeveloperApiEntity.new(@_client, opts)
  end
  ...
  # @return [DeveloperApi, Hash] the current DeveloperApi data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeveloperApi fields)
  def match_get
  ...
  #
  # @param reqmatch [DeveloperApiLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DeveloperApi.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DeveloperApi, Hash] the loaded DeveloperApi; raises MemesioContentCreationError on failure
  ...
  #
  # @param reqdata [DeveloperApiCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [DeveloperApi, Hash] the created DeveloperApi; raises MemesioContentCreationError on failure
