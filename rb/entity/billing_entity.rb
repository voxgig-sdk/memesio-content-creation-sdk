# MemesioContentCreation SDK Billing entity
...
class BillingEntity
  ...
  def make
    opts = @_entopts.dup
    BillingEntity.new(@_client, opts)
  end
  ...
  # @return [Billing, Hash] the current Billing data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Billing fields)
  def match_get
  ...
  #
  # @param reqmatch [BillingLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Billing.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Billing, Hash] the loaded Billing; raises MemesioContentCreationError on failure
