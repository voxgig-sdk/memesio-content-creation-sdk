...
class AiProviderEntity
  ...
  def make
    opts = @_entopts.dup
    AiProviderEntity.new(@_client, opts)
  end
  ...
  # @return [AiProvider, Hash] the current AiProvider data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AiProvider fields)
  def match_get
  ...
  #
  # @param reqmatch [AiProviderLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.AiProvider.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [AiProvider, Hash] the loaded AiProvider; raises MemesioContentCreationError on failure
  ...
  #
  # @param reqdata [AiProviderCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AiProvider, Hash] the created AiProvider; raises MemesioContentCreationError on failure
