# MemesioContentCreation SDK Video entity
...
class VideoEntity
  ...
  # @return [Video, Hash] the loaded Video; raises MemesioContentCreationError on failure
  ...
  # Create a new Video.
  #
  # @param reqdata [VideoCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Video, Hash] the created Video; raises MemesioContentCreationError on failure
