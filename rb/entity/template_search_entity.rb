...
class TemplateSearchEntity
  ...
  def make
    opts = @_entopts.dup
    TemplateSearchEntity.new(@_client, opts)
  end
  ...
  # @return [TemplateSearch, Hash] the current TemplateSearch data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TemplateSearch fields)
  def match_get
  ...
  #
  # @param reqmatch [TemplateSearchListMatch, Hash, nil] match filter (any subset of
  #   TemplateSearch fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<TemplateSearch>, Array] the matching TemplateSearch items; raises MemesioContentCreationError on failure
