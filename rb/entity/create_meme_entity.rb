...
class CreateMemeEntity
  ...
  def make
    opts = @_entopts.dup
    CreateMemeEntity.new(@_client, opts)
  end
  ...
  # @return [CreateMeme, Hash] the current CreateMeme data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CreateMeme fields)
  def match_get
  ...
  #
  # @param reqdata [CreateMemeCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CreateMeme, Hash] the created CreateMeme; raises MemesioContentCreationError on failure
