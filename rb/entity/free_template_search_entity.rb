...
class FreeTemplateSearchEntity
  ...
  def make
    opts = @_entopts.dup
    FreeTemplateSearchEntity.new(@_client, opts)
  end
  ...
  # @return [FreeTemplateSearch, Hash] the current FreeTemplateSearch data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FreeTemplateSearch fields)
  def match_get
  ...
  #
  # @param reqmatch [FreeTemplateSearchListMatch, Hash, nil] match filter (any subset of
  #   FreeTemplateSearch fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<FreeTemplateSearch>, Array] the matching FreeTemplateSearch items; raises MemesioContentCreationError on failure
