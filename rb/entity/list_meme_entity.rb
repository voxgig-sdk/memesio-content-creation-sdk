...
class ListMemeEntity
  ...
  def make
    opts = @_entopts.dup
    ListMemeEntity.new(@_client, opts)
  end
  ...
  # @return [ListMeme, Hash] the current ListMeme data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ListMeme fields)
  def match_get
  ...
  #
  # @param reqmatch [ListMemeListMatch, Hash, nil] match filter (any subset of
  #   ListMeme fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ListMeme>, Array] the matching ListMeme items; raises MemesioContentCreationError on failure
