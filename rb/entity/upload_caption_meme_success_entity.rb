...
class UploadCaptionMemeSuccessEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "upload_caption_meme_success"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    UploadCaptionMemeSuccessEntity.new(@_client, opts)
  end
  ...
  # @return [UploadCaptionMemeSuccess, Hash] the current UploadCaptionMemeSuccess data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UploadCaptionMemeSuccess fields)
  def match_get
  ...
  #
  # @param reqdata [UploadCaptionMemeSuccessCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UploadCaptionMemeSuccess, Hash] the created UploadCaptionMemeSuccess; raises MemesioContentCreationError on failure
