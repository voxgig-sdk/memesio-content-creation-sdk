...
class StandaloneAgentBootstrapEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "standalone_agent_bootstrap"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    StandaloneAgentBootstrapEntity.new(@_client, opts)
  end
  ...
  # @return [StandaloneAgentBootstrap, Hash] the current StandaloneAgentBootstrap data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StandaloneAgentBootstrap fields)
  def match_get
  ...
  #
  # @param reqdata [StandaloneAgentBootstrapCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [StandaloneAgentBootstrap, Hash] the created StandaloneAgentBootstrap; raises MemesioContentCreationError on failure
