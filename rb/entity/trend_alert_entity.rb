...
class TrendAlertEntity
  ...
  def make
    opts = @_entopts.dup
    TrendAlertEntity.new(@_client, opts)
  end
  ...
  # @return [TrendAlert, Hash] the current TrendAlert data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TrendAlert fields)
  def match_get
  ...
  #
  # @param reqmatch [TrendAlertLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.TrendAlert.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [TrendAlert, Hash] the loaded TrendAlert; raises MemesioContentCreationError on failure
  ...
  #
  # @param reqdata [TrendAlertCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TrendAlert, Hash] the created TrendAlert; raises MemesioContentCreationError on failure
