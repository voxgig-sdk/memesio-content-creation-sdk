...
class AiCaptionEntity
  ...
  def make
    opts = @_entopts.dup
    AiCaptionEntity.new(@_client, opts)
  end
  ...
  # @return [AiCaption, Hash] the current AiCaption data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AiCaption fields)
  def match_get
  ...
  #
  # @param reqmatch [AiCaptionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.AiCaption.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [AiCaption, Hash] the loaded AiCaption; raises MemesioContentCreationError on failure
  ...
  #
  # @param reqdata [AiCaptionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AiCaption, Hash] the created AiCaption; raises MemesioContentCreationError on failure
