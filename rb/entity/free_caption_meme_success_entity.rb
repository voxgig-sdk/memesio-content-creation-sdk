...
class FreeCaptionMemeSuccessEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "free_caption_meme_success"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    FreeCaptionMemeSuccessEntity.new(@_client, opts)
  end
  ...
  # @return [FreeCaptionMemeSuccess, Hash] the current FreeCaptionMemeSuccess data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FreeCaptionMemeSuccess fields)
  def match_get
  ...
  #
  # @param reqdata [FreeCaptionMemeSuccessCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [FreeCaptionMemeSuccess, Hash] the created FreeCaptionMemeSuccess; raises MemesioContentCreationError on failure
