...
class CollaborationEntity
  ...
  #
  # @param reqmatch [CollaborationLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Collaboration.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Collaboration, Hash] the loaded Collaboration; raises MemesioContentCreationError on failure
  ...
  #
  # @param reqdata [CollaborationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Collaboration, Hash] the created Collaboration; raises MemesioContentCreationError on failure
