...
class AiJobEntity
  ...
  # @return [AiJob, Hash] the current AiJob data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AiJob fields)
  def match_get
  ...
  # Load a single AiJob.
  #
  # @param reqmatch [AiJobLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.AiJob.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [AiJob, Hash] the loaded AiJob; raises MemesioContentCreationError on failure
  ...
  # Create a new AiJob.
  #
  # @param reqdata [AiJobCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AiJob, Hash] the created AiJob; raises MemesioContentCreationError on failure
