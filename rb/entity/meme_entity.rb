...
class MemeEntity
  ...
  # @return [Meme, Hash] the current Meme data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Meme fields)
  def match_get
  ...
  # Load a single Meme.
  #
  # @param reqmatch [MemeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Meme.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Meme, Hash] the loaded Meme; raises MemesioContentCreationError on failure
  ...
  #
  # @param reqmatch [MemeRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Meme, Hash] the removed Meme; raises MemesioContentCreationError on failure
