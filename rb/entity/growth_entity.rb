...
class GrowthEntity
  ...
  # @return [Growth, Hash] the current Growth data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Growth fields)
  def match_get
  ...
  #
  # @param reqmatch [GrowthLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Growth.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Growth, Hash] the loaded Growth; raises MemesioContentCreationError on failure
  ...
  # Create a new Growth.
  #
  # @param reqdata [GrowthCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Growth, Hash] the created Growth; raises MemesioContentCreationError on failure
