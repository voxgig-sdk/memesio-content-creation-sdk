# MemesioContentCreation SDK Agent entity
...
class AgentEntity
  ...
  # @return [Agent, Hash] the loaded Agent; raises MemesioContentCreationError on failure
  ...
  # Create a new Agent.
  #
  # @param reqdata [AgentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Agent, Hash] the created Agent; raises MemesioContentCreationError on failure
  ...
  #
  # @param reqdata [AgentUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Agent, Hash] the updated Agent; raises MemesioContentCreationError on failure
