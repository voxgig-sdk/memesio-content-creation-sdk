...
#      offline in seeded test mode (MemesioContentCreationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MemesioContentCreation_sdk.rb")
  SDK_CLASS = "MemesioContentCreationSDK"
  ...
  SDK_BASE = "MemesioContentCreation_sdk"
