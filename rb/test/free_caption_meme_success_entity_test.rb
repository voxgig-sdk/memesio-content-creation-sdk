...
class FreeCaptionMemeSuccessEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MEMESIOCONTENTCREATION_TEST_FREE_CAPTION_MEME_SUCCESS_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def free_caption_meme_success_basic_setup(extra)
  ...
  entid_env_raw = ENV["MEMESIOCONTENTCREATION_TEST_FREE_CAPTION_MEME_SUCCESS_ENTID"]
