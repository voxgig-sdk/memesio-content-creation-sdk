...
class TemplateSearchEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MEMESIO_CONTENT_CREATION_TEST_TEMPLATE_SEARCH_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def template_search_basic_setup(extra)
  ...
  entid_env_raw = ENV["MEMESIO_CONTENT_CREATION_TEST_TEMPLATE_SEARCH_ENTID"]
