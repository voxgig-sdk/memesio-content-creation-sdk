...
class AnalyticsEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MEMESIOCONTENTCREATION_TEST_ANALYTICS_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def analytics_basic_setup(extra)
  ...
  entid_env_raw = ENV["MEMESIOCONTENTCREATION_TEST_ANALYTICS_ENTID"]
