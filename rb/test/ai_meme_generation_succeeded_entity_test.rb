...
class AiMemeGenerationSucceededEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MEMESIOCONTENTCREATION_TEST_AI_MEME_GENERATION_SUCCEEDED_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def ai_meme_generation_succeeded_basic_setup(extra)
  ...
  entid_env_raw = ENV["MEMESIOCONTENTCREATION_TEST_AI_MEME_GENERATION_SUCCEEDED_ENTID"]
