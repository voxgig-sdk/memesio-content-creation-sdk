...
class BillingEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MEMESIOCONTENTCREATION_TEST_BILLING_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def billing_basic_setup(extra)
  ...
  entid_env_raw = ENV["MEMESIOCONTENTCREATION_TEST_BILLING_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["MEMESIOCONTENTCREATION_TEST_BILLING_ENTID"])
