...
function envOverride(m) {
    if ('TRUE' === process.env.MEMESIO_CONTENT_CREATION_TEST_LIVE ||
        'TRUE' === process.env.MEMESIO_CONTENT_CREATION_TEST_OVERRIDE) {
    ...
    m.MEMESIO_CONTENT_CREATION_TEST_EXPLAIN = process.env.MEMESIO_CONTENT_CREATION_TEST_EXPLAIN || m.MEMESIO_CONTENT_CREATION_TEST_EXPLAIN;
    return m;
}
