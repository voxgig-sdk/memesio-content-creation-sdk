...
(0, node_test_1.describe)('AiJobEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'ai_job.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set MEMESIO_CONTENT_CREATION_TEST_AI_JOB_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != ai_job_ref01_data.id);
        // LOAD
        const ai_job_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(ai_job_ref01_data_dt0.id === ai_job_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/ai_job/AiJobTestData.json');
    ...
    let idmap = transform(['ai_job01', 'ai_job02', 'ai_job03', 'job01', 'job02', 'job03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['MEMESIO_CONTENT_CREATION_TEST_AI_JOB_ENTID'];
...
//# sourceMappingURL=AiJobEntity.test.js.map