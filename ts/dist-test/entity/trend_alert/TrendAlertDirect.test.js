...
(0, node_test_1.describe)('TrendAlertDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-trend_alert', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-trend_alert', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'MEMESIO_CONTENT_CREATION_TEST_TREND_ALERT_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['MEMESIO_CONTENT_CREATION_TEST_TREND_ALERT_ENTID'];
...
//# sourceMappingURL=TrendAlertDirect.test.js.map