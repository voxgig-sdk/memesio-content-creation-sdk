...
(0, node_test_1.describe)('TrendAlertEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.TrendAlert();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.MEMESIO_CONTENT_CREATION_TEST_LIVE;
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'trend_alert.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != trend_alert_ref01_data);
        // LOAD
        const trend_alert_ref01_match_dt0 = {};
        const trend_alert_ref01_data_dt0 = (await trend_alert_ref01_ent.load(trend_alert_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != trend_alert_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/trend_alert/TrendAlertTestData.json');
    ...
    let idmap = transform(['trend_alert01', 'trend_alert02', 'trend_alert03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['MEMESIO_CONTENT_CREATION_TEST_TREND_ALERT_ENTID'];
    ...
    idmap = env['MEMESIO_CONTENT_CREATION_TEST_TREND_ALERT_ENTID'];
...
//# sourceMappingURL=TrendAlertEntity.test.js.map