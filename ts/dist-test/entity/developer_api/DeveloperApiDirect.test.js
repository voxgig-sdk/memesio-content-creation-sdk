...
(0, node_test_1.describe)('DeveloperApiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-developer_api', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-developer_api', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MEMESIO_CONTENT_CREATION_TEST_DEVELOPER_API_ENTID'];
...
//# sourceMappingURL=DeveloperApiDirect.test.js.map