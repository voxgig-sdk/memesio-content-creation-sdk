...
(0, node_test_1.describe)('DeveloperApiEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'developer_api.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != developer_api_ref01_data);
        // LOAD
        const developer_api_ref01_match_dt0 = {};
        const developer_api_ref01_data_dt0 = (await developer_api_ref01_ent.load(developer_api_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != developer_api_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/developer_api/DeveloperApiTestData.json');
    ...
    let idmap = transform(['developer_api01', 'developer_api02', 'developer_api03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['MEMESIO_CONTENT_CREATION_TEST_DEVELOPER_API_ENTID'];
...
//# sourceMappingURL=DeveloperApiEntity.test.js.map