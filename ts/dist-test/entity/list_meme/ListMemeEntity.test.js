...
(0, node_test_1.describe)('ListMemeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let list_meme_ref01_data = Object.values(setup.data.existing.list_meme)[0];
        // LIST
        const list_meme_ref01_ent = client.ListMeme();
        const list_meme_ref01_match = {};
        const list_meme_ref01_list = (await list_meme_ref01_ent.list(list_meme_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/list_meme/ListMemeTestData.json');
    ...
    let idmap = transform(['list_meme01', 'list_meme02', 'list_meme03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ListMemeEntity.test.js.map