...
(0, node_test_1.describe)('ListMemeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-list_meme', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-list_meme', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MEMESIO_CONTENT_CREATION_TEST_LIST_MEME_ENTID'];
...
//# sourceMappingURL=ListMemeDirect.test.js.map