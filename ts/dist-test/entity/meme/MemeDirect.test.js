...
(0, node_test_1.describe)('MemeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-meme', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-meme', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MEMESIO_CONTENT_CREATION_TEST_MEME_ENTID'];
...
//# sourceMappingURL=MemeDirect.test.js.map