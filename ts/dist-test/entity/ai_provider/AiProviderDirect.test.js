...
(0, node_test_1.describe)('AiProviderDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ai_provider', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ai_provider', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MEMESIO_CONTENT_CREATION_TEST_AI_PROVIDER_ENTID'];
...
//# sourceMappingURL=AiProviderDirect.test.js.map