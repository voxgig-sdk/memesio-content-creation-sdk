...
(0, node_test_1.describe)('TemplateSearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-template_search', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-template_search', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MEMESIO_CONTENT_CREATION_TEST_TEMPLATE_SEARCH_ENTID'];
...
//# sourceMappingURL=TemplateSearchDirect.test.js.map