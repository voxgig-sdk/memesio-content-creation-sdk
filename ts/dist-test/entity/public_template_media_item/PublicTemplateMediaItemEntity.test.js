...
(0, node_test_1.describe)('PublicTemplateMediaItemEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'public_template_media_item.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != public_template_media_item_ref01_data.id);
        // LOAD
        const public_template_media_item_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(public_template_media_item_ref01_data_dt0.id === public_template_media_item_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/public_template_media_item/PublicTemplateMediaItemTestData.json');
    ...
    let idmap = transform(['public_template_media_item01', 'public_template_media_item02', 'public_template_media_item03', 'gif01', 'gif02', 'gif03', 'template01', 'template02', 'template03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['MEMESIO_CONTENT_CREATION_TEST_PUBLIC_TEMPLATE_MEDIA_ITEM_ENTID'];
...
//# sourceMappingURL=PublicTemplateMediaItemEntity.test.js.map