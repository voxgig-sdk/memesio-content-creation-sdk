...
(0, node_test_1.describe)('PublicTemplateMediaItemDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MemesioContentCreationSDK({
    ...
    (0, node_test_1.test)('direct-load-public_template_media_item', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-public_template_media_item', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MemesioContentCreationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.MEMESIO_CONTENT_CREATION_APIKEY,
        }));
        let idmap = env['MEMESIO_CONTENT_CREATION_TEST_PUBLIC_TEMPLATE_MEDIA_ITEM_ENTID'];
    ...
    const client = new __1.MemesioContentCreationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PublicTemplateMediaItemDirect.test.js.map