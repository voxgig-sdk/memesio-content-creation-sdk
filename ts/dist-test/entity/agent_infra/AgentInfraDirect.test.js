...
(0, node_test_1.describe)('AgentInfraDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-agent_infra', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-agent_infra', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MEMESIO_CONTENT_CREATION_TEST_AGENT_INFRA_ENTID'];
...
//# sourceMappingURL=AgentInfraDirect.test.js.map