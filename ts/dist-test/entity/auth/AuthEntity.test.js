...
(0, node_test_1.describe)('AuthEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'auth.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['MEMESIO_CONTENT_CREATION_TEST_AUTH_ENTID'];
    ...
    idmap = env['MEMESIO_CONTENT_CREATION_TEST_AUTH_ENTID'];
