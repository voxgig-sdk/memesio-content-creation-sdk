...
(0, node_test_1.describe)('FreeTemplateSearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-free_template_search', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-free_template_search', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MEMESIO_CONTENT_CREATION_TEST_FREE_TEMPLATE_SEARCH_ENTID'];
...
//# sourceMappingURL=FreeTemplateSearchDirect.test.js.map