...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['MEMESIO_CONTENT_CREATION_TEST_VIDEO_ENTID'];
    ...
    idmap = env['MEMESIO_CONTENT_CREATION_TEST_VIDEO_ENTID'];
