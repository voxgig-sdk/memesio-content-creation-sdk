...
(0, node_test_1.describe)('CollaborationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-collaboration', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-collaboration', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MEMESIO_CONTENT_CREATION_TEST_COLLABORATION_ENTID'];
