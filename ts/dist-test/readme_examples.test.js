...
const __1 = require("..");
const SDK_NAME = 'MemesioContentCreationSDK';
...
const TEST_SEED = { "entity": { "agent": { "test01": { "id": "test01" } }, "agent_infra": { "test01": { "id": "test01" } }, "ai_caption": { "test01": { "id": "test01" } }, "ai_job": { "test01": { "id": "test01" } }, "ai_meme_generation_succeeded": { "test01": { "id": "test01" } }, "ai_provider": { "test01": { "id": "test01" } }, "analytics": { "test01": { "id": "test01" } }, "auth": { "test01": { "id": "test01" } }, "billing": { "test01": { "id": "test01" } }, "collaboration": { "test01": { "id": "test01" } }, "compliance": { "test01": { "id": "test01" } }, "create_meme": { "test01": { "id": "test01" } }, "developer_api": { "test01": { "id": "test01" } }, "free_caption_meme_success": { "test01": { "id": "test01" } }, "free_template_search": { "test01": { "id": "test01" } }, "generate": { "test01": { "id": "test01" } }, "growth": { "test01": { "id": "test01" } }, "list_meme": { "test01": { "id": "test01" } }, "media": { "test01": { "id": "test01" } }, "meme": { "test01": { "id": "test01" } }, "public_template_media_item": { "test01": { "id": "test01" } }, "standalone_agent_bootstrap": { "test01": { "id": "test01" } }, "template": { "test01": { "id": "test01" } }, "template_search": { "test01": { "id": "test01" } }, "trend_alert": { "test01": { "id": "test01" } }, "upload_caption_meme_success": { "test01": { "id": "test01" } }, "video": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+MemesioContentCreationSDK\b/.test(code) ||
        /\bMemesioContentCreationSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+MemesioContentCreationSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/MemesioContentCreationSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
