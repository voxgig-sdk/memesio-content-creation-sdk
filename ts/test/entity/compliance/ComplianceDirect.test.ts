...
describe('ComplianceDirect', async () => {
  ...
  test('direct-load-compliance', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-compliance', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MEMESIO_CONTENT_CREATION_TEST_COMPLIANCE_ENTID']
