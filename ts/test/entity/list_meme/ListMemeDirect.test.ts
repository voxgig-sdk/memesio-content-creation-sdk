...
describe('ListMemeDirect', async () => {
  ...
  test('direct-list-list_meme', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-list_meme', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MEMESIO_CONTENT_CREATION_TEST_LIST_MEME_ENTID']
