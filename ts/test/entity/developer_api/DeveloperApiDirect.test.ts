...
describe('DeveloperApiDirect', async () => {
  ...
  test('direct-load-developer_api', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-developer_api', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MEMESIO_CONTENT_CREATION_TEST_DEVELOPER_API_ENTID']
