...
describe('AgentInfraDirect', async () => {
  ...
  test('direct-load-agent_infra', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-agent_infra', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MEMESIO_CONTENT_CREATION_TEST_AGENT_INFRA_ENTID']
