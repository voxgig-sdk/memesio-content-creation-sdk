...
describe('MemeDirect', async () => {
  ...
  test('direct-load-meme', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-meme', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MEMESIO_CONTENT_CREATION_TEST_MEME_ENTID']
