...
describe('FreeTemplateSearchDirect', async () => {
  ...
  test('direct-list-free_template_search', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-free_template_search', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MEMESIOCONTENTCREATION_TEST_FREE_TEMPLATE_SEARCH_ENTID']
