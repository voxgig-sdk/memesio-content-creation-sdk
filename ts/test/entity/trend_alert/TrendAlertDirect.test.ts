...
describe('TrendAlertDirect', async () => {
  ...
  test('direct-load-trend_alert', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-trend_alert', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MEMESIO_CONTENT_CREATION_TEST_TREND_ALERT_ENTID']
