...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MEMESIOCONTENTCREATION_TEST_LIVE ||
    'TRUE' === process.env.MEMESIOCONTENTCREATION_TEST_OVERRIDE
  ) {
  ...
  m.MEMESIOCONTENTCREATION_TEST_EXPLAIN = process.env.MEMESIOCONTENTCREATION_TEST_EXPLAIN || m.MEMESIOCONTENTCREATION_TEST_EXPLAIN
