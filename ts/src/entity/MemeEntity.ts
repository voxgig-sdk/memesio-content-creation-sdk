...
class MemeEntity extends MemesioContentCreationEntityBase<Meme> {
  ...
  make(this: MemeEntity) {
    return new MemeEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: MemeLoadMatch, ctrl?: Control): Promise<MemeEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Meme> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: MemeRemoveMatch, ctrl?: Control,
  ): Promise<MemeEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<MemeEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
