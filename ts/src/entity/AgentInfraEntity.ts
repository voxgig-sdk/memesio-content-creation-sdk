...
import type {
  AgentInfra,
  AgentInfraLoadMatch,
  AgentInfraCreateData,
  AgentInfraRemoveMatch,
} from '../MemesioContentCreationTypes'

// TODO: needs Entity superclass
class AgentInfraEntity extends MemesioContentCreationEntityBase<AgentInfra> {

  constructor(client: MemesioContentCreationSDK, entopts: any) {
    super(client, entopts)
    this.name = 'agent_infra'
    this.name_ = 'agent_infra'
    this.Name = 'AgentInfra'
  }


  make(this: AgentInfraEntity) {
    return new AgentInfraEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AgentInfraLoadMatch, ctrl?: Control): Promise<AgentInfraEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<AgentInfra> return stays clean under strict null checks.
  ...
  async create(this: any, reqdata?: AgentInfraCreateData, ctrl?: Control): Promise<AgentInfraEntity> {
  ...
  async remove(
    this: any, reqmatch?: AgentInfraRemoveMatch, ctrl?: Control,
  ): Promise<AgentInfraEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<AgentInfraEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
