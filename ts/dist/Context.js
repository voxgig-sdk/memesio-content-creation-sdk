...
const MemesioContentCreationError_1 = require("./MemesioContentCreationError");
...
class Context {
    ...
    error(code, msg) {
        return new MemesioContentCreationError_1.MemesioContentCreationError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
