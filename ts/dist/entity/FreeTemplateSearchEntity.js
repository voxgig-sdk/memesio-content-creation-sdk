...
class FreeTemplateSearchEntity extends MemesioContentCreationEntityBase_1.MemesioContentCreationEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'free_template_search';
        this.name_ = 'free_template_search';
        this.Name = 'FreeTemplateSearch';
    }
    make() {
        return new FreeTemplateSearchEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<FreeTemplateSearch[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.FreeTemplateSearchEntity = FreeTemplateSearchEntity;
//# sourceMappingURL=FreeTemplateSearchEntity.js.map