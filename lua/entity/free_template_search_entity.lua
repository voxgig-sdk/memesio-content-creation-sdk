...
local FreeTemplateSearchEntity = {}
FreeTemplateSearchEntity.__index = FreeTemplateSearchEntity


function FreeTemplateSearchEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FreeTemplateSearchEntity)
  self._name = "free_template_search"
  self._client = client
...
function FreeTemplateSearchEntity:get_name()
  return self._name
end


function FreeTemplateSearchEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FreeTemplateSearchEntity.new(self._client, opts)
end
...
function FreeTemplateSearchEntity:mark_deleted()
  self._deleted = true
end


function FreeTemplateSearchEntity:deleted()
  return true == self._deleted
end


function FreeTemplateSearchEntity:data_set(args)
  if args ~= nil then
...
function FreeTemplateSearchEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FreeTemplateSearchEntity:match_set(args)
  if args ~= nil then
...
function FreeTemplateSearchEntity:match_get()
...
function FreeTemplateSearchEntity:stream(action, args, callopts)
...
---@param reqmatch FreeTemplateSearchListMatch
---@param ctrl? table
---@return FreeTemplateSearch[]
---@return string? err
function FreeTemplateSearchEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function FreeTemplateSearchEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return FreeTemplateSearchEntity
