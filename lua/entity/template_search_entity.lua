...
local TemplateSearchEntity = {}
TemplateSearchEntity.__index = TemplateSearchEntity


function TemplateSearchEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TemplateSearchEntity)
  self._name = "template_search"
  self._client = client
...
function TemplateSearchEntity:get_name()
  return self._name
end


function TemplateSearchEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TemplateSearchEntity.new(self._client, opts)
end
...
function TemplateSearchEntity:mark_deleted()
  self._deleted = true
end


function TemplateSearchEntity:deleted()
  return true == self._deleted
end


function TemplateSearchEntity:data_set(args)
  if args ~= nil then
...
function TemplateSearchEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TemplateSearchEntity:match_set(args)
  if args ~= nil then
...
function TemplateSearchEntity:match_get()
...
function TemplateSearchEntity:stream(action, args, callopts)
...
---@param reqmatch TemplateSearchListMatch
---@param ctrl? table
---@return TemplateSearch[]
---@return string? err
function TemplateSearchEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function TemplateSearchEntity:_run_op(ctx, post_done)
  local utility = self._utility
