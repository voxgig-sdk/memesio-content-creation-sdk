...
local MemeEntity = {}
MemeEntity.__index = MemeEntity


function MemeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MemeEntity)
  self._name = "meme"
  self._client = client
...
function MemeEntity:get_name()
  return self._name
end


function MemeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MemeEntity.new(self._client, opts)
end
...
function MemeEntity:mark_deleted()
  self._deleted = true
end


function MemeEntity:deleted()
  return true == self._deleted
end


function MemeEntity:data_set(args)
  if args ~= nil then
...
function MemeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MemeEntity:match_set(args)
  if args ~= nil then
...
function MemeEntity:stream(action, args, callopts)
...
---@param reqmatch MemeLoadMatch
---@param ctrl? table
---@return Meme
---@return string? err
function MemeEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MemeRemoveMatch
---@param ctrl? table
---@return Meme
---@return string? err
function MemeEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function MemeEntity:_run_op(ctx, post_done)
  local utility = self._utility
