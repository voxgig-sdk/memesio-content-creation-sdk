-- MemesioContentCreation SDK UploadCaptionMemeSuccess entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local UploadCaptionMemeSuccessEntity = {}
UploadCaptionMemeSuccessEntity.__index = UploadCaptionMemeSuccessEntity


function UploadCaptionMemeSuccessEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UploadCaptionMemeSuccessEntity)
  self._name = "upload_caption_meme_success"
  self._client = client
...
function UploadCaptionMemeSuccessEntity:get_name()
  return self._name
end


function UploadCaptionMemeSuccessEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UploadCaptionMemeSuccessEntity.new(self._client, opts)
end
...
function UploadCaptionMemeSuccessEntity:mark_deleted()
  self._deleted = true
end


function UploadCaptionMemeSuccessEntity:deleted()
  return true == self._deleted
end


function UploadCaptionMemeSuccessEntity:data_set(args)
  if args ~= nil then
...
function UploadCaptionMemeSuccessEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UploadCaptionMemeSuccessEntity:match_set(args)
  if args ~= nil then
...
function UploadCaptionMemeSuccessEntity:match_get()
...
function UploadCaptionMemeSuccessEntity:stream(action, args, callopts)
...
---@param reqdata UploadCaptionMemeSuccessCreateData
---@param ctrl? table
---@return UploadCaptionMemeSuccess
---@return string? err
function UploadCaptionMemeSuccessEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function UploadCaptionMemeSuccessEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UploadCaptionMemeSuccessEntity
