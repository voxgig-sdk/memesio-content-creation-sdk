...
local DeveloperApiEntity = {}
DeveloperApiEntity.__index = DeveloperApiEntity


function DeveloperApiEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeveloperApiEntity)
  self._name = "developer_api"
  self._client = client
...
function DeveloperApiEntity:get_name()
  return self._name
end


function DeveloperApiEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeveloperApiEntity.new(self._client, opts)
end
...
function DeveloperApiEntity:mark_deleted()
  self._deleted = true
end


function DeveloperApiEntity:deleted()
  return true == self._deleted
end


function DeveloperApiEntity:data_set(args)
  if args ~= nil then
...
function DeveloperApiEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeveloperApiEntity:match_set(args)
  if args ~= nil then
...
function DeveloperApiEntity:match_get()
...
function DeveloperApiEntity:stream(action, args, callopts)
...
---@param reqmatch DeveloperApiLoadMatch
---@param ctrl? table
---@return DeveloperApi
---@return string? err
function DeveloperApiEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DeveloperApiCreateData
---@param ctrl? table
---@return DeveloperApi
---@return string? err
function DeveloperApiEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function DeveloperApiEntity:_run_op(ctx, post_done)
  local utility = self._utility
