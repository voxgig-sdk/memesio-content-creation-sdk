...
local AgentInfraEntity = {}
AgentInfraEntity.__index = AgentInfraEntity


function AgentInfraEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AgentInfraEntity)
  self._name = "agent_infra"
  self._client = client
...
function AgentInfraEntity:get_name()
  return self._name
end


function AgentInfraEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AgentInfraEntity.new(self._client, opts)
end
...
function AgentInfraEntity:mark_deleted()
  self._deleted = true
end


function AgentInfraEntity:deleted()
  return true == self._deleted
end


function AgentInfraEntity:data_set(args)
  if args ~= nil then
...
function AgentInfraEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AgentInfraEntity:match_set(args)
  if args ~= nil then
...
function AgentInfraEntity:match_get()
...
function AgentInfraEntity:stream(action, args, callopts)
...
---@param reqmatch AgentInfraLoadMatch
---@param ctrl? table
---@return AgentInfra
---@return string? err
function AgentInfraEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata AgentInfraCreateData
---@param ctrl? table
---@return AgentInfra
---@return string? err
function AgentInfraEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch AgentInfraRemoveMatch
---@param ctrl? table
---@return AgentInfra
---@return string? err
function AgentInfraEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function AgentInfraEntity:_run_op(ctx, post_done)
  local utility = self._utility
