-- MemesioContentCreation SDK PublicTemplateMediaItem entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local PublicTemplateMediaItemEntity = {}
PublicTemplateMediaItemEntity.__index = PublicTemplateMediaItemEntity


function PublicTemplateMediaItemEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PublicTemplateMediaItemEntity)
  self._name = "public_template_media_item"
  self._client = client
...
function PublicTemplateMediaItemEntity:get_name()
  return self._name
end


function PublicTemplateMediaItemEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PublicTemplateMediaItemEntity.new(self._client, opts)
end
...
function PublicTemplateMediaItemEntity:mark_deleted()
  self._deleted = true
end


function PublicTemplateMediaItemEntity:deleted()
  return true == self._deleted
end


function PublicTemplateMediaItemEntity:data_set(args)
  if args ~= nil then
...
function PublicTemplateMediaItemEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PublicTemplateMediaItemEntity:match_set(args)
  if args ~= nil then
...
function PublicTemplateMediaItemEntity:match_get()
...
function PublicTemplateMediaItemEntity:stream(action, args, callopts)
...
---@param reqmatch PublicTemplateMediaItemLoadMatch
---@param ctrl? table
---@return PublicTemplateMediaItem
---@return string? err
function PublicTemplateMediaItemEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata PublicTemplateMediaItemCreateData
---@param ctrl? table
---@return PublicTemplateMediaItem
---@return string? err
function PublicTemplateMediaItemEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function PublicTemplateMediaItemEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PublicTemplateMediaItemEntity
