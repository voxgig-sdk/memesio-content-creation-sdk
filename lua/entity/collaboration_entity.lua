...
---@param reqmatch CollaborationLoadMatch
---@param ctrl? table
---@return Collaboration
---@return string? err
function CollaborationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata CollaborationCreateData
---@param ctrl? table
---@return Collaboration
---@return string? err
function CollaborationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
