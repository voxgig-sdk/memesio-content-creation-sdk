...
local ListMemeEntity = {}
ListMemeEntity.__index = ListMemeEntity


function ListMemeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ListMemeEntity)
  self._name = "list_meme"
  self._client = client
...
function ListMemeEntity:get_name()
  return self._name
end


function ListMemeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ListMemeEntity.new(self._client, opts)
end
...
function ListMemeEntity:mark_deleted()
  self._deleted = true
end


function ListMemeEntity:deleted()
  return true == self._deleted
end


function ListMemeEntity:data_set(args)
  if args ~= nil then
...
function ListMemeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ListMemeEntity:match_set(args)
  if args ~= nil then
...
function ListMemeEntity:match_get()
...
function ListMemeEntity:stream(action, args, callopts)
...
---@param reqmatch ListMemeListMatch
---@param ctrl? table
---@return ListMeme[]
---@return string? err
function ListMemeEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ListMemeEntity:_run_op(ctx, post_done)
  local utility = self._utility
