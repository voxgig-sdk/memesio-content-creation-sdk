...
local GrowthEntity = {}
GrowthEntity.__index = GrowthEntity


function GrowthEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GrowthEntity)
  self._name = "growth"
  self._client = client
...
function GrowthEntity:get_name()
  return self._name
end


function GrowthEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GrowthEntity.new(self._client, opts)
end
...
function GrowthEntity:mark_deleted()
  self._deleted = true
end


function GrowthEntity:deleted()
  return true == self._deleted
end


function GrowthEntity:data_set(args)
  if args ~= nil then
...
function GrowthEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GrowthEntity:match_set(args)
  if args ~= nil then
...
function GrowthEntity:match_get()
...
function GrowthEntity:stream(action, args, callopts)
...
---@param reqmatch GrowthLoadMatch
---@param ctrl? table
---@return Growth
---@return string? err
function GrowthEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata GrowthCreateData
---@param ctrl? table
---@return Growth
---@return string? err
function GrowthEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function GrowthEntity:_run_op(ctx, post_done)
  local utility = self._utility
