...
local TrendAlertEntity = {}
TrendAlertEntity.__index = TrendAlertEntity


function TrendAlertEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TrendAlertEntity)
  self._name = "trend_alert"
  self._client = client
...
function TrendAlertEntity:get_name()
  return self._name
end


function TrendAlertEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TrendAlertEntity.new(self._client, opts)
end
...
function TrendAlertEntity:mark_deleted()
  self._deleted = true
end


function TrendAlertEntity:deleted()
  return true == self._deleted
end


function TrendAlertEntity:data_set(args)
  if args ~= nil then
...
function TrendAlertEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TrendAlertEntity:match_set(args)
  if args ~= nil then
...
function TrendAlertEntity:match_get()
...
function TrendAlertEntity:stream(action, args, callopts)
...
---@param reqmatch TrendAlertLoadMatch
---@param ctrl? table
---@return TrendAlert
---@return string? err
function TrendAlertEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata TrendAlertCreateData
---@param ctrl? table
---@return TrendAlert
---@return string? err
function TrendAlertEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function TrendAlertEntity:_run_op(ctx, post_done)
  local utility = self._utility
