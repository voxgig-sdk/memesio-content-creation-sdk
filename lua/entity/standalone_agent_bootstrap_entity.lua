-- MemesioContentCreation SDK StandaloneAgentBootstrap entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local StandaloneAgentBootstrapEntity = {}
StandaloneAgentBootstrapEntity.__index = StandaloneAgentBootstrapEntity


function StandaloneAgentBootstrapEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, StandaloneAgentBootstrapEntity)
  self._name = "standalone_agent_bootstrap"
  self._client = client
...
function StandaloneAgentBootstrapEntity:get_name()
  return self._name
end


function StandaloneAgentBootstrapEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return StandaloneAgentBootstrapEntity.new(self._client, opts)
end
...
function StandaloneAgentBootstrapEntity:mark_deleted()
  self._deleted = true
end


function StandaloneAgentBootstrapEntity:deleted()
  return true == self._deleted
end


function StandaloneAgentBootstrapEntity:data_set(args)
  if args ~= nil then
...
function StandaloneAgentBootstrapEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function StandaloneAgentBootstrapEntity:match_set(args)
  if args ~= nil then
...
function StandaloneAgentBootstrapEntity:match_get()
...
function StandaloneAgentBootstrapEntity:stream(action, args, callopts)
...
---@param reqdata StandaloneAgentBootstrapCreateData
---@param ctrl? table
---@return StandaloneAgentBootstrap
---@return string? err
function StandaloneAgentBootstrapEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function StandaloneAgentBootstrapEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return StandaloneAgentBootstrapEntity
