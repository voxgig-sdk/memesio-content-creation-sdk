...
describe("DeveloperApiEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MEMESIO_CONTENT_CREATION_TEST_DEVELOPER_API_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    developer_api_ref01_data = helpers.to_map(type(developer_api_ref01_data_result) == 'table' and developer_api_ref01_data_result.data_get and developer_api_ref01_data_result:data_get() or developer_api_ref01_data_result)
...
function developer_api_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MEMESIO_CONTENT_CREATION_TEST_DEVELOPER_API_ENTID")
