...
describe("MemeDirect", function()
  it("should direct-load-meme", function()
    local setup = meme_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-meme", setup.live and "live" or "unit")
...
function meme_direct_setup(mockres)
