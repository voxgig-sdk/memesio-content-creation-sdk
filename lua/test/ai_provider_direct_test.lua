...
describe("AiProviderDirect", function()
  it("should direct-load-ai_provider", function()
    local setup = ai_provider_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ai_provider", setup.live and "live" or "unit")
...
function ai_provider_direct_setup(mockres)
