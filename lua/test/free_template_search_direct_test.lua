-- FreeTemplateSearch direct test
...
describe("FreeTemplateSearchDirect", function()
  it("should direct-list-free_template_search", function()
    local setup = free_template_search_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-free_template_search", setup.live and "live" or "unit")
...
function free_template_search_direct_setup(mockres)
  runner.load_env_local()

  local calls = {}

  local env = runner.env_override({
    ["MEMESIOCONTENTCREATION_TEST_FREE_TEMPLATE_SEARCH_ENTID"] = {},
