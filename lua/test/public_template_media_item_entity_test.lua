...
describe("PublicTemplateMediaItemEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MEMESIO_CONTENT_CREATION_TEST_PUBLIC_TEMPLATE_MEDIA_ITEM_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    local public_template_media_item_ref01_data_dt0_load_result = helpers.to_map(type(public_template_media_item_ref01_data_dt0_loaded) == 'table' and public_template_media_item_ref01_data_dt0_loaded.data_get and public_template_media_item_ref01_data_dt0_loaded:data_get() or public_template_media_item_ref01_data_dt0_loaded)
...
function public_template_media_item_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MEMESIO_CONTENT_CREATION_TEST_PUBLIC_TEMPLATE_MEDIA_ITEM_ENTID")
