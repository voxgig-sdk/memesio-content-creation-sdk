...
describe("DeveloperApiDirect", function()
  it("should direct-load-developer_api", function()
    local setup = developer_api_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-developer_api", setup.live and "live" or "unit")
...
function developer_api_direct_setup(mockres)
