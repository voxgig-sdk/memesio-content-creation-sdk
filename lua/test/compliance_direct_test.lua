...
describe("ComplianceDirect", function()
  it("should direct-load-compliance", function()
    local setup = compliance_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-compliance", setup.live and "live" or "unit")
...
function compliance_direct_setup(mockres)
