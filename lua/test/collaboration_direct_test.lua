...
describe("CollaborationDirect", function()
  it("should direct-load-collaboration", function()
    local setup = collaboration_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-collaboration", setup.live and "live" or "unit")
