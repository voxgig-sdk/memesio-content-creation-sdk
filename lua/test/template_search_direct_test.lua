...
describe("TemplateSearchDirect", function()
  it("should direct-list-template_search", function()
    local setup = template_search_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-template_search", setup.live and "live" or "unit")
...
function template_search_direct_setup(mockres)
