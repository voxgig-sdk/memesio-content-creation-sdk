...
describe("TrendAlertDirect", function()
  it("should direct-load-trend_alert", function()
    local setup = trend_alert_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-trend_alert", setup.live and "live" or "unit")
...
function trend_alert_direct_setup(mockres)
