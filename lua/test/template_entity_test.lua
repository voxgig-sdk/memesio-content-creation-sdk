...
describe("TemplateEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MEMESIOCONTENTCREATION_TEST_TEMPLATE_ENTID JSON to run live")
      return
    end
...
function template_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MEMESIOCONTENTCREATION_TEST_TEMPLATE_ENTID")
