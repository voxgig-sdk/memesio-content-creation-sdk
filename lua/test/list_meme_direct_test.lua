...
describe("ListMemeDirect", function()
  it("should direct-list-list_meme", function()
    local setup = list_meme_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-list_meme", setup.live and "live" or "unit")
...
function list_meme_direct_setup(mockres)
