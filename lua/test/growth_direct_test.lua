...
describe("GrowthDirect", function()
  it("should direct-load-growth", function()
    local setup = growth_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-growth", setup.live and "live" or "unit")
...
function growth_direct_setup(mockres)
