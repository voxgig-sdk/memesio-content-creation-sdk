...
describe("AiCaptionDirect", function()
  it("should direct-load-ai_caption", function()
    local setup = ai_caption_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ai_caption", setup.live and "live" or "unit")
...
function ai_caption_direct_setup(mockres)
