...
describe("AgentInfraEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MEMESIOCONTENTCREATION_TEST_AGENT_INFRA_ENTID JSON to run live")
      return
    end
...
function agent_infra_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MEMESIOCONTENTCREATION_TEST_AGENT_INFRA_ENTID")
