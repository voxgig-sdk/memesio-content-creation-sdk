...
describe("AgentInfraDirect", function()
  it("should direct-load-agent_infra", function()
    local setup = agent_infra_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-agent_infra", setup.live and "live" or "unit")
...
function agent_infra_direct_setup(mockres)
