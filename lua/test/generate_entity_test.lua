...
describe("GenerateEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MEMESIO_CONTENT_CREATION_TEST_GENERATE_ENTID JSON to run live")
      return
    end
...
function generate_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MEMESIO_CONTENT_CREATION_TEST_GENERATE_ENTID")
