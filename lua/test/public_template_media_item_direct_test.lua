-- PublicTemplateMediaItem direct test
...
describe("PublicTemplateMediaItemDirect", function()
  it("should direct-load-public_template_media_item", function()
    local setup = public_template_media_item_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-public_template_media_item", setup.live and "live" or "unit")
...
function public_template_media_item_direct_setup(mockres)
