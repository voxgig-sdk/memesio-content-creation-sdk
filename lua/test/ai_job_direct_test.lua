...
describe("AiJobDirect", function()
  it("should direct-load-ai_job", function()
    local setup = ai_job_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ai_job", setup.live and "live" or "unit")
...
function ai_job_direct_setup(mockres)
